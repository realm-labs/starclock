...
fn config_validation_uses_only_a_validated_sora_bundle() {
    ...
    assert_eq!(
        ...
        "{\"schema_revision\":\"starclock-cli-v1\",\"kind\":\"config-validation\",\"valid\":true,\"game_version\":\"4.4\",\"data_revision\":\"core-combat-v1-phase7-l01\",\"bundle_sha256\":\"2e9e7c6e288b436b2cf53687adc43a77c556c2eb33026e5b27cec7d4517f8418\",\"identities\":4519,\"enabled\":4370}"
    );
    ...
    assert!(human.contains("identities=4519 enabled=4370"));
...
fn coverage_is_goal_aware_filterable_and_not_readiness_inflated() {
    ...
    assert!(
        all.contains("\"required\":283,\"enabled\":134,\"data_ready\":134,\"golden_verified\":134")
    );
    for expected in [
    ...
    assert!(filtered.contains("\"data_ready\":16"));
