...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            0xf0, 0x16, 0x3f, 0xc1, 0x15, 0xcc, 0x6a, 0x37, 0x7a, 0xed, 0x48, 0x92, 0xcf, 0x9a,
            0x8f, 0x0d, 0x4b, 0xb1, 0x09, 0x2d, 0xf2, 0x50, 0xf8, 0x98, 0x2b, 0xa1, 0x9e, 0x55,
            0x11, 0x5a, 0xee, 0xe1,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0x65, 0x1c, 0x3d, 0x8c, 0x3c, 0x42, 0x70, 0x62, 0xc1, 0xb3, 0xcc, 0x3b, 0xc8, 0x26,
            0x6e, 0xcf, 0x9b, 0x77, 0xb2, 0x17, 0xcc, 0x31, 0xfd, 0x6d, 0x76, 0xed, 0x0c, 0x32,
            0xc4, 0x11, 0xce, 0x7f,
        ]
    );
    assert!(matches!(
