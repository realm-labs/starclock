...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            0x8c, 0xd4, 0x14, 0xe2, 0xa8, 0xb5, 0x5f, 0xaa, 0xab, 0x2a, 0xf6, 0x14, 0x18, 0x3e,
            0xcd, 0x38, 0x84, 0x73, 0xcf, 0x3b, 0x95, 0xf6, 0x47, 0xd0, 0x6b, 0x4b, 0x32, 0x7e,
            0xa0, 0x91, 0xb2, 0x2d,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0xc1, 0x90, 0x73, 0x1d, 0x73, 0x05, 0x79, 0xc1, 0xb7, 0x25, 0xcc, 0xa3, 0x35, 0x0b,
            0x42, 0xc3, 0x70, 0xb1, 0x0c, 0xc1, 0xa4, 0xb7, 0x4c, 0xe9, 0x3f, 0x4a, 0x2f, 0x1b,
            0xef, 0xdc, 0x34, 0x4c,
        ]
    );
    assert!(matches!(
