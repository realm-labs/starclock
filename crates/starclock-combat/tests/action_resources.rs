...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            0xb0, 0xda, 0x82, 0x89, 0x0e, 0x94, 0x8c, 0xa4, 0x24, 0xab, 0x96, 0xaf, 0xe3, 0x87,
            0x58, 0x73, 0x65, 0x3f, 0xa9, 0xf3, 0x2a, 0x7a, 0x08, 0xb7, 0xb1, 0xfe, 0x53, 0x59,
            0x04, 0xf3, 0x10, 0xed,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0x0f, 0x54, 0x28, 0x81, 0x8b, 0xea, 0x98, 0xcd, 0x43, 0xbb, 0x74, 0x11, 0xa2, 0x61,
            0x59, 0x28, 0x70, 0x32, 0xdd, 0x55, 0xcb, 0x42, 0x57, 0xbb, 0xe7, 0x46, 0x9d, 0x2e,
            0x47, 0x32, 0x24, 0x6c,
        ]
    );
    assert!(matches!(
