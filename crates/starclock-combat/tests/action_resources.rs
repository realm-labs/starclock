...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            93, 119, 34, 137, 2, 241, 200, 253, 121, 16, 41, 22, 37, 76, 9, 72, 255, 118, 239, 33,
            160, 198, 7, 72, 4, 172, 150, 248, 119, 109, 31, 162,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            136, 30, 214, 242, 114, 146, 165, 103, 186, 83, 221, 155, 200, 116, 85, 105, 157, 118,
            150, 88, 44, 133, 64, 159, 150, 130, 100, 193, 209, 107, 133, 243,
        ]
    );
    assert!(matches!(
        resolution.events()[2].kind(),
