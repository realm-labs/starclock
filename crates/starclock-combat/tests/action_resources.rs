...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            0x7c, 0xe6, 0xee, 0x52, 0xe4, 0x6a, 0x51, 0xa3, 0x87, 0x14, 0xc8, 0x40, 0x06, 0x71,
            0x90, 0xe7, 0xdf, 0x1d, 0x5c, 0x8a, 0x2d, 0xb5, 0x66, 0x06, 0xb1, 0xb0, 0x5f, 0x20,
            0x70, 0x7a, 0x32, 0xf4,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0x94, 0x84, 0x83, 0x64, 0xae, 0xe7, 0xce, 0xd5, 0x83, 0x69, 0x2c, 0xe3, 0xab, 0x00,
            0x08, 0x69, 0xcf, 0xa0, 0x4e, 0xe7, 0x11, 0xa4, 0x33, 0x47, 0xa4, 0x80, 0xb9, 0xfb,
            0xf9, 0xd1, 0x78, 0x85,
        ]
    );
    assert!(matches!(
