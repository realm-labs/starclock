...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            0x2f, 0x0d, 0x99, 0x91, 0x2c, 0x60, 0x6d, 0x66, 0xa8, 0x42, 0x5d, 0xa1, 0xda, 0x32,
            0x62, 0xdf, 0x4e, 0x18, 0xd9, 0xb1, 0xbe, 0xe6, 0x5d, 0xe8, 0xe8, 0x6f, 0x6f, 0x59,
            0x98, 0x10, 0x94, 0x9a,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0xf5, 0x0c, 0x8d, 0xed, 0xdd, 0x22, 0x0a, 0x6d, 0x53, 0x14, 0x98, 0x23, 0x3b, 0x0c,
            0x77, 0xe6, 0x4d, 0x49, 0x56, 0xde, 0xe8, 0xee, 0x95, 0x6c, 0x0a, 0x49, 0x2b, 0xc7,
            0x4c, 0x5a, 0x56, 0xdc,
        ]
    );
    assert!(matches!(
