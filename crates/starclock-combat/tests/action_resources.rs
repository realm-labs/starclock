...
fn ultimate_and_skill_resources_gate_offers_and_multi_hit_target_locks() {
    ...
    assert_eq!(
        ...
        [
            0x9c, 0x42, 0x0a, 0x6b, 0xaa, 0x47, 0x47, 0xbb, 0xd2, 0x33, 0xbe, 0x5d, 0x5c, 0xae,
            0x17, 0x07, 0xd0, 0x70, 0xfb, 0xa9, 0x88, 0x39, 0x2a, 0x6f, 0x68, 0x2d, 0x7d, 0x07,
            0x93, 0xda, 0x16, 0xbe,
        ]
    );
    assert!(matches!(
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0x43, 0xaf, 0x21, 0x89, 0x81, 0x1d, 0xb1, 0xfa, 0xb8, 0xb9, 0x92, 0x39, 0xa9, 0x41,
            0xd0, 0x4d, 0x63, 0x2a, 0x7d, 0x81, 0xb7, 0xb0, 0xb5, 0xca, 0x97, 0x97, 0xb2, 0x87,
            0x9a, 0x63, 0x4c, 0x66,
        ]
    );
    assert!(matches!(
