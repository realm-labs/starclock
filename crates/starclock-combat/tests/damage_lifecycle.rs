...
fn damage_and_healing_emit_calculated_and_effective_hp_facts() {
    ...
    assert_eq!(
        ...
        [
            0x00, 0x8b, 0x9f, 0x0c, 0x47, 0xf3, 0x0b, 0x63, 0xd3, 0x81, 0x94, 0xdb, 0x36, 0xde,
            0x68, 0xfe, 0x73, 0x07, 0x07, 0x4b, 0xc3, 0x83, 0x2d, 0x98, 0xe2, 0x80, 0xbd, 0x8d,
            0xc1, 0xed, 0x2b, 0x4d,
        ]
    );
...
fn single_wave_defeat_settles_to_victory_and_terminal_rejection_is_immutable() {
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0xb7, 0x9e, 0xac, 0xd4, 0x07, 0x0c, 0xa7, 0x3b, 0xe4, 0xf9, 0x5b, 0xd6, 0xf8, 0x8e,
            0x76, 0x50, 0x24, 0xd8, 0x87, 0xd8, 0xb5, 0xa6, 0x60, 0x61, 0x08, 0xe6, 0xb5, 0xc8,
            0x89, 0x31, 0xd2, 0x56,
        ]
    );
    assert_eq!(resolution.phase(), BattlePhase::Won);
...
fn after_action_wave_transition_does_not_let_later_hits_reach_reserve_units() {
    ...
    assert_eq!(
        ...
        [
            0x15, 0x8e, 0xf1, 0x5d, 0xd6, 0x65, 0x4a, 0xd3, 0x32, 0xbb, 0x88, 0x8e, 0x23, 0x01,
            0x40, 0x45, 0x96, 0x29, 0xab, 0xc6, 0x6f, 0xfd, 0x5b, 0x9f, 0x2e, 0x4c, 0xf1, 0xfe,
            0x65, 0x0c, 0xa7, 0x1e,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0x27, 0xa8, 0xb7, 0x56, 0x59, 0x09, 0xc8, 0x21, 0x09, 0xcf, 0xcb, 0xa9, 0x2e, 0xae,
            0xea, 0xd6, 0xbf, 0x2c, 0xc2, 0x72, 0x59, 0x6d, 0xd7, 0x25, 0xeb, 0xb5, 0x12, 0xd8,
            0xff, 0x11, 0x1f, 0xbc,
        ]
    );
...
fn defeating_the_last_player_settles_loss() {
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0xc5, 0x2f, 0x99, 0xab, 0x32, 0x89, 0x87, 0x82, 0xa0, 0x67, 0x01, 0xd9, 0xd4, 0x29,
            0xd6, 0x97, 0xea, 0xfe, 0x84, 0xab, 0x32, 0x24, 0xcc, 0x18, 0x81, 0x28, 0x4c, 0xc8,
            0x32, 0x0a, 0x34, 0x00,
        ]
    );
