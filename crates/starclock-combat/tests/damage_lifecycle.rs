...
fn damage_and_healing_emit_calculated_and_effective_hp_facts() {
    ...
    assert_eq!(
        ...
        [
            0x12, 0xd5, 0x7a, 0xce, 0xc2, 0xaf, 0x43, 0xf2, 0x51, 0x34, 0x55, 0xb9, 0x60, 0xea,
            0x1d, 0x85, 0xa5, 0x58, 0x2d, 0x1d, 0xf5, 0x1f, 0x57, 0x62, 0xb7, 0x01, 0x54, 0xc5,
            0x7c, 0xf2, 0xff, 0x1d,
        ]
    );
...
fn single_wave_defeat_settles_to_victory_and_terminal_rejection_is_immutable() {
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0x9a, 0xbb, 0x96, 0xb6, 0x7a, 0x99, 0x91, 0x56, 0xc4, 0x83, 0x5b, 0x2c, 0x45, 0x8a,
            0x46, 0x99, 0x6b, 0xa8, 0x45, 0x5f, 0x77, 0xf4, 0x87, 0xce, 0x4a, 0xa8, 0x54, 0xf1,
            0x52, 0x31, 0x80, 0x96,
        ]
    );
    assert_eq!(resolution.phase(), BattlePhase::Won);
...
fn after_action_wave_transition_does_not_let_later_hits_reach_reserve_units() {
    ...
    assert_eq!(
        ...
        [
            0x92, 0xb3, 0x96, 0x34, 0xc4, 0xc2, 0xce, 0x7c, 0x2f, 0x1f, 0x79, 0xef, 0x72, 0xb8,
            0xa5, 0xdc, 0x43, 0x73, 0x54, 0x70, 0x15, 0xfb, 0x12, 0x8a, 0x44, 0xf5, 0x53, 0xa7,
            0x36, 0xef, 0xe6, 0x85,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0x15, 0x2c, 0x5c, 0x27, 0x40, 0x96, 0xc0, 0x81, 0x85, 0x6a, 0x6f, 0xd0, 0xff, 0x86,
            0xb9, 0x5f, 0xc3, 0x85, 0x47, 0xb7, 0x6a, 0xee, 0x80, 0x88, 0x51, 0x25, 0xaf, 0x45,
            0x0f, 0x78, 0xc3, 0x7a,
        ]
    );
...
fn defeating_the_last_player_settles_loss() {
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0xfa, 0x64, 0xc4, 0xcc, 0x58, 0x31, 0xf7, 0xdf, 0x55, 0x1a, 0xdc, 0x85, 0x3c, 0x1e,
            0x39, 0xd4, 0xd4, 0x10, 0x69, 0x89, 0x6e, 0x4f, 0x39, 0x59, 0x97, 0x5e, 0x91, 0xa7,
            0x8b, 0x6b, 0xf3, 0xe1,
        ]
    );
