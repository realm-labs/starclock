...
fn damage_and_healing_emit_calculated_and_effective_hp_facts() {
    ...
    assert_eq!(
        ...
        [
            0x12, 0x4c, 0x93, 0x62, 0x4a, 0xd5, 0x28, 0xc5, 0xe9, 0x2f, 0x5d, 0x3d, 0x48, 0x2a,
            0x21, 0xd1, 0xb3, 0x75, 0x99, 0x41, 0x87, 0x22, 0xb7, 0xe3, 0x99, 0x7f, 0x39, 0x0c,
            0xc3, 0xa5, 0x9d, 0xd6,
        ]
    );
...
fn single_wave_defeat_settles_to_victory_and_terminal_rejection_is_immutable() {
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0xb2, 0x11, 0x24, 0x55, 0xd9, 0xd1, 0x03, 0xa2, 0xc6, 0x24, 0x84, 0x51, 0x9c, 0x91,
            0x22, 0x29, 0x8b, 0x9d, 0x9b, 0xa3, 0xc5, 0x9b, 0x70, 0xfc, 0x85, 0xba, 0xbd, 0x49,
            0x68, 0x47, 0x43, 0x87,
        ]
    );
    assert_eq!(resolution.phase(), BattlePhase::Won);
...
fn after_action_wave_transition_does_not_let_later_hits_reach_reserve_units() {
    ...
    assert_eq!(
        ...
        [
            0x14, 0x25, 0x84, 0xc2, 0x79, 0x9d, 0x36, 0x98, 0xa5, 0x0e, 0x64, 0x51, 0x04, 0x3d,
            0xe4, 0xca, 0x1e, 0xcd, 0x36, 0xdb, 0x36, 0x29, 0x0b, 0x4e, 0x98, 0x2d, 0x5b, 0x34,
            0xd6, 0x96, 0x72, 0x8e,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0x88, 0x29, 0x81, 0x26, 0x00, 0x23, 0x3d, 0xa1, 0x27, 0x6e, 0x06, 0x4d, 0x84, 0xb0,
            0x50, 0x57, 0x5d, 0x76, 0x5c, 0xd6, 0x0d, 0xe1, 0x9b, 0x71, 0x9d, 0x68, 0xbc, 0x91,
            0x24, 0x58, 0xfc, 0xd0,
        ]
    );
...
fn defeating_the_last_player_settles_loss() {
    ...
    assert_eq!(
        resolution.state_hash().bytes(),
        [
            0x82, 0x2d, 0xb1, 0xf6, 0x64, 0xc0, 0x8a, 0x1e, 0xda, 0xf5, 0x2b, 0x80, 0xc8, 0x8f,
            0x5a, 0x57, 0xe9, 0x5e, 0xb1, 0x02, 0x8c, 0x15, 0x2d, 0x41, 0x99, 0x29, 0xe9, 0x40,
            0xd5, 0x9c, 0x89, 0x77,
        ]
    );
