...
fn battle_construction_allocates_canonical_private_stores_and_read_only_views() {
    ...
    assert_eq!(view.identity().state_hash_revision(), "sha256-v2");
...
fn rejected_stale_forged_and_terminal_commands_preserve_observable_state() {
    ...
    assert_eq!(
        ...
        [
            0xc5, 0x0d, 0xbe, 0x12, 0x0b, 0x2b, 0xb8, 0x5b, 0x57, 0xff, 0x9e, 0x75, 0x47, 0xbf,
            0x67, 0x70, 0x98, 0xa2, 0xcd, 0xec, 0x1f, 0xb6, 0x56, 0x26, 0x4c, 0x4f, 0x87, 0xab,
            0x30, 0x0a, 0xb0, 0xfa,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0xed, 0x98, 0x85, 0x9b, 0x25, 0x24, 0x56, 0x9b, 0xde, 0xe9, 0xd2, 0xbc, 0xc7, 0x18,
            0x51, 0x9c, 0x9c, 0x38, 0x70, 0x0d, 0x6c, 0xf9, 0x83, 0x76, 0x35, 0xcd, 0x3d, 0x25,
            0x8c, 0x59, 0xe7, 0xef,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0xa6, 0x6b, 0x91, 0x0f, 0x85, 0x04, 0xd6, 0x39, 0xe4, 0xe0, 0xb5, 0xa8, 0x69, 0xf0,
            0x5b, 0xfb, 0x2e, 0xc2, 0x95, 0x9f, 0x0f, 0xaa, 0x23, 0xdb, 0x58, 0x8e, 0x93, 0x50,
            0x5b, 0xb1, 0xfe, 0xf8,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0xf1, 0xbe, 0x70, 0x9d, 0xc5, 0x5b, 0x59, 0x7a, 0x3f, 0xe2, 0x2e, 0x50, 0xde, 0xf9,
            0x62, 0x52, 0x46, 0x1a, 0x78, 0x7c, 0xc9, 0x4f, 0x36, 0x5c, 0x22, 0x85, 0x83, 0x5a,
            0x5f, 0x5b, 0x03, 0x7a,
        ]
    );
...
fn normal_action_lowers_one_phase_and_hit_then_selects_the_next_turn() {
    ...
    assert_eq!(
        ...
        [
            0x1a, 0x82, 0x54, 0x7b, 0x22, 0x0c, 0x9f, 0xde, 0xe3, 0x32, 0xf5, 0xab, 0x95, 0x12,
            0x8c, 0x47, 0xc0, 0xa9, 0xf5, 0x0e, 0x63, 0xe5, 0x0d, 0x9c, 0x04, 0x13, 0xa4, 0xca,
            0x36, 0xe5, 0xa1, 0xd0,
        ]
    );
