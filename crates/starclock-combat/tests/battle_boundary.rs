...
fn rejected_stale_forged_and_terminal_commands_preserve_observable_state() {
    ...
    assert_eq!(
        ...
        [
            0xb9, 0x90, 0xca, 0x0d, 0x06, 0xa8, 0x46, 0x47, 0x60, 0x43, 0x0f, 0xc0, 0xf0, 0xc7,
            0xe8, 0xe6, 0x43, 0x04, 0x1b, 0x20, 0xcf, 0x2e, 0xa9, 0xd7, 0xb9, 0xeb, 0x12, 0x97,
            0xc5, 0x8e, 0x8a, 0x88,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0x18, 0xf0, 0x83, 0x08, 0x91, 0xbc, 0x30, 0xd1, 0x94, 0x0d, 0xda, 0xe3, 0x74, 0xed,
            0x70, 0x76, 0x10, 0x34, 0x60, 0x17, 0x52, 0x5a, 0xad, 0x47, 0xa6, 0xd8, 0x03, 0xac,
            0xb2, 0x78, 0x54, 0x18,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0xce, 0xe6, 0xe8, 0x3b, 0xee, 0xa1, 0x02, 0xf8, 0x9b, 0x3b, 0x9c, 0x81, 0x4d, 0x86,
            0xc1, 0xc7, 0x27, 0x5f, 0xb3, 0xe0, 0xae, 0x4c, 0x42, 0xf3, 0xae, 0x11, 0x04, 0x31,
            0x5e, 0x6a, 0x73, 0x66,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            0xd5, 0x16, 0x7a, 0x26, 0xe8, 0x7a, 0xc0, 0x05, 0x9e, 0x92, 0x3e, 0xb1, 0x55, 0x10,
            0xa6, 0x6b, 0xda, 0xbb, 0xe8, 0xfa, 0xe5, 0x6b, 0x80, 0x90, 0x07, 0x8c, 0xf0, 0x2e,
            0x7d, 0x6f, 0x26, 0x77,
        ]
    );
...
fn normal_action_lowers_one_phase_and_hit_then_selects_the_next_turn() {
    ...
    assert_eq!(
        ...
        [
            0xee, 0xc2, 0x23, 0xef, 0x9e, 0x33, 0x33, 0xac, 0x06, 0x59, 0xcf, 0x6a, 0xbf, 0xa3,
            0xf0, 0xcf, 0x28, 0x2f, 0x60, 0xe5, 0xe5, 0xd7, 0x5e, 0xa2, 0x1c, 0xa2, 0x28, 0xf6,
            0xa7, 0x93, 0x20, 0x43,
        ]
    );
