...
fn one_battle_handoff_accepts_only_the_declared_projection_and_reaches_terminal() {
    ...
    assert_eq!(
        initial_hash.bytes(),
        [
            235, 246, 13, 98, 17, 103, 7, 181, 54, 29, 121, 144, 140, 244, 5, 27, 103, 75, 129,
            235, 14, 24, 227, 253, 177, 156, 70, 148, 150, 20, 118, 219,
        ]
    );
    ...
    assert_eq!(
        handoff.seed().bytes(),
        [
            190, 11, 51, 238, 46, 251, 184, 219, 251, 95, 247, 67, 33, 118, 144, 31, 32, 171, 236,
            26, 143, 25, 195, 253, 244, 116, 210, 162, 208, 186, 7, 2,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            153, 177, 71, 203, 33, 25, 49, 49, 8, 73, 91, 70, 239, 156, 235, 131, 98, 123, 159, 89,
            83, 61, 43, 95, 91, 56, 129, 165, 226, 105, 252, 197,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            239, 165, 153, 122, 173, 12, 110, 229, 151, 82, 152, 15, 235, 252, 166, 137, 143, 76,
            19, 225, 218, 141, 231, 239, 28, 144, 66, 149, 33, 175, 243, 109,
        ]
    );
    assert!(matches!(
