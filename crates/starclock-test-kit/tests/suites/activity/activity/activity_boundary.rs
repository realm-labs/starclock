...
fn one_battle_handoff_accepts_only_the_declared_projection_and_reaches_terminal() {
    ...
    assert_eq!(
        initial_hash.bytes(),
        [
            161, 57, 100, 241, 58, 170, 93, 195, 61, 93, 167, 131, 161, 226, 82, 54, 242, 132, 205,
            20, 170, 60, 160, 187, 22, 244, 194, 151, 76, 245, 144, 199,
        ]
    );
    ...
    assert_eq!(
        handoff.seed().bytes(),
        [
            87, 250, 178, 73, 37, 165, 182, 62, 149, 196, 193, 13, 81, 235, 249, 84, 28, 163, 240,
            99, 69, 25, 75, 104, 50, 1, 4, 169, 46, 87, 41, 126,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            244, 180, 22, 186, 60, 148, 43, 124, 68, 200, 168, 14, 152, 89, 209, 146, 17, 134, 32,
            87, 123, 19, 9, 181, 206, 89, 10, 164, 5, 209, 60, 33,
        ]
    );
    ...
    assert_eq!(
        ...
        [
            118, 79, 255, 95, 6, 202, 78, 198, 147, 71, 22, 154, 121, 10, 206, 86, 222, 18, 57, 3,
            163, 217, 140, 10, 249, 169, 186, 122, 50, 108, 78, 14,
        ]
    );
    assert!(matches!(
