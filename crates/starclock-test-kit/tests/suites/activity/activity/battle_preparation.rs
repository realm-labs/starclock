...
fn accumulated_and_attacking_techniques_select_one_exact_immutable_battle_variant() {
    ...
    assert_eq!(
        ...
        [
            60, 28, 52, 204, 45, 48, 252, 24, 112, 10, 244, 218, 240, 42, 61, 124, 34, 16, 191,
            110, 16, 126, 148, 71, 132, 116, 188, 138, 10, 20, 50, 19,
        ]
    );
    assert_eq!(
        state
    ...
    assert_eq!(
        ...
        [
            207, 171, 65, 146, 254, 187, 22, 177, 152, 99, 245, 96, 93, 195, 244, 144, 65, 223,
            155, 214, 184, 170, 133, 19, 126, 114, 60, 131, 4, 246, 247, 144,
        ]
    );
    assert_eq!(
