...
fn accumulated_and_attacking_techniques_select_one_exact_immutable_battle_variant() {
    ...
    assert_eq!(
        ...
        [
            187, 243, 147, 154, 177, 124, 87, 186, 226, 177, 253, 112, 12, 213, 74, 18, 109, 190,
            226, 84, 177, 58, 202, 214, 172, 166, 211, 239, 162, 76, 96, 145,
        ]
    );
    assert_eq!(
        state
    ...
    assert_eq!(
        ...
        [
            163, 7, 81, 243, 191, 67, 209, 108, 136, 57, 55, 136, 37, 62, 78, 141, 196, 191, 8, 26,
            219, 12, 22, 140, 77, 0, 98, 237, 171, 184, 189, 210,
        ]
    );
    assert_eq!(
