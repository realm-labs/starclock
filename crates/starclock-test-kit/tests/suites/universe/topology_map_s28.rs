...
const SOURCE_MAPS: [u32; 5] = [704, 801, 802, 803, 804];
...
#[test]
fn goal07_p5_m15_s28_materializes_five_complete_topology_maps() {
    ...
    text(&mut hasher, "starclock-goal07-p5-m15-s28-topology-maps-v1");
    ...
    assert_eq!(
        digest,
        [
            183, 185, 229, 151, 71, 186, 215, 95, 183, 86, 199, 23, 37, 38, 254, 217, 245, 4, 255,
            221, 106, 27, 225, 119, 195, 233, 248, 36, 90, 55, 9, 92,
        ]
    );
}

#[test]
fn goal07_p5_m15_s28_keeps_every_edge_inside_one_bounded_map() {
