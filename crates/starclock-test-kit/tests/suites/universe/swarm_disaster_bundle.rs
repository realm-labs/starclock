...
fn component_set_has_exact_ten_component_closure_and_stable_order() {
    ...
    assert_eq!(
        ...
        [
            169, 51, 17, 223, 253, 165, 37, 172, 28, 43, 170, 71, 220, 54, 199, 108, 22, 124, 226,
            21, 36, 64, 134, 11, 211, 203, 104, 249, 184, 117, 32, 173,
        ]
    );
    assert_eq!(
        components.components()[3].digest().bytes(),
        [
            34, 26, 197, 6, 187, 40, 191, 132, 53, 66, 213, 95, 96, 137, 156, 113, 24, 22, 240,
            126, 44, 38, 204, 249, 253, 129, 209, 135, 13, 72, 7, 5,
        ]
    );
    assert_eq!(
        components.components()[6].digest().bytes(),
        [
            27, 148, 81, 253, 195, 32, 138, 58, 176, 251, 222, 10, 225, 23, 29, 15, 116, 222, 74,
            176, 161, 94, 12, 139, 64, 4, 185, 193, 65, 253, 42, 121,
        ]
    );
}
...
fn component_roots_are_mode_scoped_and_controller_sensitive() {
    ...
    assert_eq!(
        gold.root().bytes(),
        [
            54, 252, 234, 107, 235, 101, 37, 67, 90, 199, 230, 46, 40, 206, 87, 240, 215, 6, 117,
            115, 216, 184, 128, 247, 209, 195, 171, 114, 107, 187, 187, 207,
        ]
    );
