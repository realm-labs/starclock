...
fn production_executor_runs_real_nested_battles_and_settles_activity_carry() {
    ...
    assert_eq!(
        ...
        [
            25, 134, 95, 159, 255, 194, 157, 22, 250, 248, 77, 244, 40, 129, 235, 32, 3, 239, 48,
            237, 30, 31, 45, 30, 70, 125, 97, 108, 25, 154, 150, 144,
        ]
    );
    assert_eq!(
        executor.reports()[0].event_digest().bytes(),
        [
            156, 100, 170, 6, 46, 45, 142, 14, 80, 125, 246, 8, 225, 17, 220, 105, 6, 65, 207, 92,
            243, 165, 83, 200, 125, 178, 65, 252, 22, 118, 24, 252,
        ]
    );
