...
fn main() {
    assert!(
        std::env::args().len() == 1,
        "g14_gold_gears_benchmark takes no arguments"
    );
    ...
    println!(
        ...
        serde_json::to_string(&Report {
            schema_revision: "starclock.goal14-performance-report.v1",
            workload_revision: "gold-and-gears-runtime-workloads-v1",
