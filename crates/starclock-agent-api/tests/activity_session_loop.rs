...
fn activity_session_exposes_only_tokens_settles_battles_and_round_trips_replay() {
    ...
    assert_eq!(replay.bytes().len(), 51_528);
    assert_eq!(
        replay.sha256().as_str(),
        "0358d05cb4cdc8cdf6c9eddef415fe3fe0de69d9ad614b9908ac61e1ca34b1d0"
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        "bd4d438ed7022dc109901f12cf7dd3287ba08000374344e6c056c2ee5e7a816c"
    );
