...
fn activity_session_exposes_only_tokens_settles_battles_and_round_trips_replay() {
    ...
    assert_eq!(replay.bytes().len(), 51_079);
    assert_eq!(
        replay.sha256().as_str(),
        "bab73756dca3f5cfcca9e15caf4683144786fea9fa5258ea47acc260938b8fcf"
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        "98996b5d2f56ec66a492aa10a0c9d29efc8fc687eda80b1331de221cd2c815fb"
    );
