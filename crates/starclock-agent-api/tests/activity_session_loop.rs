...
fn activity_session_exposes_only_tokens_settles_battles_and_round_trips_replay() {
    ...
    assert_eq!(replay.bytes().len(), 53_759);
    assert_eq!(
        replay.sha256().as_str(),
        "d9cda0637c7353deb0152cf31af14ca6e241eed7d94a2d109a9cb23d842adb95"
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        "5e4a7d0d697e12ebb6019f450ee708e8bd84b55f2bd445b680c2719ebae50610"
    );
