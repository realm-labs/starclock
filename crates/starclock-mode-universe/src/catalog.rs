...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0x4d, 0xa6, 0xb4, 0x6e, 0xbf, 0x8f, 0xc5, 0x4f, 0x27, 0x3c, 0x0b, 0x4a, 0x11, 0x36, 0x57, 0x0a,
    0xb4, 0xdb, 0x7b, 0x05, 0xd4, 0x2b, 0x0f, 0xd6, 0xa6, 0x81, 0xd2, 0xd3, 0xfe, 0xf4, 0x71, 0x6e,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                255, 176, 62, 11, 100, 162, 227, 205, 32, 151, 122, 86, 86, 132, 58, 230, 97, 38,
                123, 205, 22, 40, 1, 55, 68, 52, 85, 1, 196, 240, 156, 50,
            ]
        );
        assert_eq!(
