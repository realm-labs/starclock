...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0xb0, 0xd8, 0x25, 0xaf, 0x4d, 0x75, 0x13, 0x1a, 0x08, 0x9e, 0xe0, 0x5b, 0x9e, 0x11, 0x3d, 0x35,
    0x68, 0x87, 0xa2, 0x96, 0x4f, 0xe9, 0x71, 0x4d, 0x4d, 0x14, 0x1d, 0x63, 0x59, 0x3c, 0x41, 0x0a,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                239, 189, 203, 79, 190, 248, 203, 224, 85, 16, 117, 136, 109, 17, 76, 230, 148,
                180, 100, 125, 178, 186, 207, 119, 172, 67, 91, 98, 115, 138, 164, 236,
            ]
        );
        assert_eq!(
