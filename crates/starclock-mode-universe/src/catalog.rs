...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0x98, 0xd2, 0xe8, 0x82, 0x89, 0x79, 0x7e, 0x33, 0x36, 0x24, 0xe5, 0x84, 0x1e, 0x5f, 0xff, 0x5c,
    0x56, 0xd3, 0x07, 0x54, 0x27, 0xe5, 0xd8, 0xf1, 0x3a, 0xcc, 0xc5, 0x2f, 0xd0, 0x14, 0x6a, 0x2e,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                187, 225, 103, 138, 69, 229, 0, 88, 77, 53, 201, 89, 15, 212, 5, 119, 150, 85, 41,
                53, 7, 211, 59, 131, 147, 166, 162, 117, 189, 76, 19, 210,
            ]
        );
        assert_eq!(
