...
const EXPECTED_UNIVERSE_BUNDLE: UniverseBundleDigest = UniverseBundleDigest::new([
    0x81, 0x06, 0x07, 0x2b, 0x4b, 0xb8, 0xd6, 0xe2, 0x53, 0x9c, 0xfb, 0x3a, 0x7a, 0xfb, 0xa0, 0x57,
    0x10, 0x4c, 0x34, 0x07, 0x07, 0x6a, 0xfa, 0x1d, 0x45, 0xa4, 0xf0, 0x0f, 0x33, 0x23, 0xb4, 0x0f,
]);
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                241, 207, 117, 18, 106, 217, 11, 243, 180, 50, 184, 97, 27, 84, 133, 88, 168, 236,
                77, 115, 110, 80, 88, 225, 99, 35, 37, 168, 88, 219, 107, 83,
            ]
        );
    }
