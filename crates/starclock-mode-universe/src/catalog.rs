...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0xce, 0x83, 0xb2, 0xce, 0xa0, 0xf6, 0x57, 0x6d, 0x46, 0xfc, 0x6b, 0x7b, 0x1c, 0x0f, 0x83, 0x21,
    0x2a, 0x82, 0x4a, 0xb0, 0xb4, 0x00, 0x60, 0x46, 0x0e, 0xf3, 0x6a, 0xa3, 0x19, 0x28, 0x31, 0x69,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                145, 68, 55, 152, 208, 84, 125, 126, 27, 26, 114, 180, 205, 147, 27, 157, 162, 4,
                32, 169, 242, 217, 181, 182, 115, 37, 210, 214, 50, 21, 155, 82,
            ]
        );
        assert_eq!(
