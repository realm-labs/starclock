...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0xdd, 0x19, 0x18, 0x16, 0x09, 0x2a, 0x8f, 0xca, 0xa4, 0x8b, 0xc4, 0xb1, 0x3d, 0xa9, 0x46, 0xfb,
    0xf8, 0x91, 0x30, 0xfa, 0x51, 0x13, 0x2b, 0xc7, 0xad, 0xfb, 0x7c, 0xe5, 0x58, 0x8a, 0xba, 0xbd,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                143, 172, 59, 182, 85, 31, 247, 106, 224, 70, 105, 65, 185, 111, 90, 62, 246, 51,
                190, 45, 165, 63, 222, 5, 223, 63, 246, 119, 95, 173, 234, 63,
            ]
        );
        assert_eq!(
