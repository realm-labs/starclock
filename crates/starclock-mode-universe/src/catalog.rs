...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0xc9, 0x6a, 0xd1, 0x9d, 0x0c, 0x95, 0xaa, 0x2e, 0x14, 0xe8, 0xc7, 0x6b, 0x67, 0x30, 0x1e, 0xd1,
    0x15, 0x21, 0x1e, 0x72, 0xe0, 0x4b, 0xf4, 0xe9, 0x16, 0x9d, 0xa3, 0xe1, 0x19, 0x25, 0x8a, 0x1f,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                6, 122, 138, 234, 86, 66, 208, 55, 214, 136, 125, 186, 76, 22, 11, 118, 8, 142,
                227, 50, 206, 169, 247, 231, 126, 76, 70, 208, 84, 95, 244, 6,
            ]
        );
        assert_eq!(
