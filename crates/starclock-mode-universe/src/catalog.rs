...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0x5b, 0x50, 0x22, 0x22, 0x8b, 0x28, 0x1b, 0xa7, 0x9d, 0xa6, 0x40, 0xe0, 0x1f, 0x8b, 0x2d, 0x5b,
    0x33, 0xde, 0xcd, 0xdb, 0x2b, 0x87, 0x03, 0x29, 0xcf, 0x8d, 0x03, 0xdf, 0xfb, 0xc9, 0xa9, 0x69,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                193, 123, 66, 191, 156, 163, 162, 67, 38, 163, 80, 19, 189, 25, 224, 173, 86, 228,
                199, 70, 121, 111, 41, 235, 55, 232, 77, 153, 149, 228, 199, 143,
            ]
        );
        assert_eq!(
