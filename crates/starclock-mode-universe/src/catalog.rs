...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0x1b, 0xc4, 0x8c, 0x35, 0x4a, 0x07, 0xa0, 0x9d, 0x60, 0x69, 0xa2, 0xe8, 0x9f, 0x59, 0xcd, 0x66,
    0xab, 0x4b, 0x3b, 0x6b, 0x6d, 0xe4, 0x56, 0x2e, 0xb0, 0x49, 0xc0, 0xeb, 0x7e, 0x9e, 0x21, 0xf8,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                146, 8, 9, 71, 50, 1, 196, 181, 17, 10, 225, 207, 220, 180, 192, 42, 42, 159, 76,
                5, 166, 234, 35, 142, 59, 239, 121, 2, 64, 110, 128, 153,
            ]
        );
        assert_eq!(
