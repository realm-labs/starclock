...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0x9e, 0xd9, 0x9b, 0x16, 0xa4, 0x6a, 0x31, 0x0b, 0x9a, 0xc8, 0x82, 0x5b, 0x13, 0xc2, 0xed, 0x3d,
    0x4b, 0xa9, 0x9d, 0xb2, 0xc9, 0x4c, 0x68, 0xd4, 0x4a, 0x6a, 0x97, 0x8b, 0xc9, 0xcf, 0xa0, 0xfb,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                140, 49, 10, 246, 108, 1, 3, 134, 166, 152, 156, 214, 92, 66, 143, 48, 37, 53, 180,
                194, 84, 251, 62, 226, 184, 60, 124, 9, 50, 13, 70, 163,
            ]
        );
        assert_eq!(
