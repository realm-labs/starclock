...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0xe0, 0xc2, 0xf8, 0x29, 0x60, 0x6c, 0x32, 0x2b, 0xcf, 0x47, 0x4a, 0xb1, 0x6b, 0x64, 0x0c, 0xf5,
    0x9b, 0xa0, 0xbc, 0xba, 0xff, 0x9a, 0x35, 0xc8, 0x38, 0x29, 0x77, 0x09, 0x85, 0x3a, 0xa3, 0x4b,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                91, 76, 164, 200, 243, 198, 248, 72, 205, 81, 132, 89, 162, 25, 148, 30, 14, 189,
                152, 113, 167, 210, 182, 136, 107, 89, 100, 81, 63, 121, 74, 221,
            ]
        );
        assert_eq!(
