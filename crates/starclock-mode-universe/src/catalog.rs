...
const EXPECTED_CORE_BUNDLE: [u8; 32] = [
    0x57, 0xa9, 0x33, 0xf1, 0x8d, 0x71, 0x19, 0xbe, 0x9f, 0xe4, 0xfa, 0xd6, 0x42, 0x98, 0xf1, 0x3a,
    0xe8, 0x8d, 0x06, 0xf0, 0x07, 0xaf, 0x3d, 0x3d, 0xb1, 0x48, 0x31, 0x31, 0x47, 0x2c, 0x26, 0xb7,
];
...
mod tests {
    ...
    fn exact_isolated_bundle_composes_with_exact_core_catalog() {
        ...
        assert_eq!(
            ...
            [
                7, 223, 104, 226, 121, 31, 144, 248, 60, 96, 95, 101, 246, 66, 116, 223, 199, 51,
                57, 238, 164, 156, 79, 22, 21, 123, 92, 207, 86, 87, 154, 251,
            ]
        );
        assert_eq!(
