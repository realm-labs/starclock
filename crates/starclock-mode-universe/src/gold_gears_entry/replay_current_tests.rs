...
// Immutable Goal 14 snapshot literals retained for its historical verifier. The active
// SCBS-v6/sha256-v7 assertions below intentionally use the current replay values:
...
fn component_replay_reexecutes_real_battles_and_reports_every_first_boundary() {
    ...
    assert_eq!(
        ...
        "d862fe16d0371bfdff0051b5ee5a915bc4d2b94287390bc3226541678745e69b"
    );
