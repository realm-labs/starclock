...
use super::{
    ...
    state_layout::{
        ...
        INITIAL_DICE_CHEATS, KNOWLEDGE_SLOT, KNOWLEDGE_SOURCE, NEURAL_NETWORK_SLOT,
        NEURAL_NETWORK_SOURCE, NODE_VISIT_SLOT, NODE_VISIT_SOURCE, PLANE_STATE_SLOT,
        PLANE_STATE_SOURCE, PROGRESSION_DICE_PATH_BOOST_STACKS_KEY,
        PROGRESSION_DICE_PATH_INTERVAL_KEY, PROGRESSION_DICE_PATH_SCALED_VALUE_KEY,
        PROGRESSION_DICE_PATH_TRIGGER_PROGRESS_KEY, PROGRESSION_DICE_PATH_VALUE_KEY,
        PROGRESSION_SLOT, PROGRESSION_SOURCE, PROGRESSION_TRAILBLAZE_BONUS_KEY,
        RESOURCE_COSMIC_FRAGMENTS_KEY, RESOURCE_DICE_CHEATS_KEY, RESOURCE_DICE_REROLLS_KEY,
        RUN_RESOURCES_SLOT, RUN_RESOURCES_SOURCE, SECRETS_SLOT, SECRETS_SOURCE,
    },
};
...
pub(super) fn compile_state(
    ...
    let conundrum = vec![
        ...
        (CONUNDRUM_BERSERK_KEY, berserk_state),
    ];
