...
const SOURCE_MAPS: [u32; 5] = [603, 604, 701, 702, 703];
...
#[test]
fn goal07_p5_m15_s27_materializes_five_complete_topology_maps() {
    ...
    text(&mut hasher, "starclock-goal07-p5-m15-s27-topology-maps-v1");
    ...
    assert_eq!(
        digest,
        [
            170, 215, 57, 228, 103, 220, 18, 213, 147, 84, 58, 69, 117, 4, 252, 214, 32, 152, 104,
            148, 244, 102, 182, 108, 100, 242, 28, 185, 14, 33, 239, 141,
        ]
    );
}

#[test]
fn goal07_p5_m15_s27_keeps_every_edge_inside_one_bounded_map() {
