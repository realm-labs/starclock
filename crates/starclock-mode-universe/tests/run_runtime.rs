...
fn all_occurrence_service_and_ability_inputs_compile_to_typed_runtime() {
    ...
    assert_eq!(
        runtime.digest(),
        [
            75, 155, 188, 190, 35, 43, 17, 92, 150, 130, 72, 186, 141, 247, 209, 47, 36, 53, 129,
            128, 130, 91, 59, 41, 70, 154, 89, 126, 195, 33, 139, 123,
        ]
    );
    assert_eq!(
        abilities.digest(),
...
fn occurrence_choices_compile_and_exact_room_sources_bind_executable_handlers() {
    ...
    assert_eq!(interaction_catalog.external_result_count(), 3_765);
