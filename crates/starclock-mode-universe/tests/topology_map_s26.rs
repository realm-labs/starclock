...
const SOURCE_MAPS: [u32; 5] = [502, 503, 504, 601, 602];
...
#[test]
fn goal07_p5_m15_s26_materializes_five_complete_topology_maps() {
    ...
    text(&mut hasher, "starclock-goal07-p5-m15-s26-topology-maps-v1");
    ...
    assert_eq!(
        digest,
        [
            129, 151, 120, 148, 189, 143, 213, 203, 221, 136, 157, 207, 21, 5, 100, 72, 137, 23,
            99, 92, 95, 233, 206, 85, 11, 20, 94, 49, 221, 226, 240, 116,
        ]
    );
}

#[test]
fn goal07_p5_m15_s26_keeps_every_edge_inside_one_bounded_map() {
