...
| Swarm Disaster | Complete Version 4.4 Activity runtime over real nested battles | 6,963 obligations, 23 rules, 23 fixtures, 65 private Sora tables and a 16-run seeded matrix | Goal 20 released with replay, baseline, CLI, agent/MCP parity and explicit versioned non-parity policies. |
