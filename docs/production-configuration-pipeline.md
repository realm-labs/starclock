...
- `config/generated/core-rust` is private pinned Sora 0.6.1 reader code.
- `config/universe-generated/rust` remains independently generated by the Universe project.
