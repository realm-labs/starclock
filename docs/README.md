...
150. [Fixed-stock shop purchases and menus](divergent-universe-shop-purchase.md) — authenticated finite Shop-card menus, atomic payment, full acquisition effects and sold-out state; controller dispatch and original merchant/price policies remain pending.
