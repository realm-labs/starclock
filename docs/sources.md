...
| [Sora v0.6.1 release](https://github.com/realm-labs/sora/releases/tag/v0.6.1) | Current pinned CLI version | Primary release record for the checksum-bound Goal 21 migration; do not float to latest in CI. |
...
| [Bilibili Star Rail Wiki — Beloved One](https://wiki.biligame.com/sr/index.php?title=%E8%B4%A7%E5%B8%81%E6%88%98%E4%BA%89/%E7%BE%81%E7%BB%8A/%E6%8C%9A%E7%88%B1%E4%B9%8B%E4%BA%BA&oldid=95782) | Cyrene's 43 released Poems: shop prices including explicit zero-cost entries, five automatic three-star effects, player-facing outcomes and the one-purchase-per-node limit | Independent released-game transcription, revision `oldid=95782`, reviewed 2026-08-19. Structured IDs, groups, qualities, paths and parameters remain pinned to the Version 4.4 source; program details not stated by either source remain `VersionedProjectPolicy`. |
