...
| Active batch | None |
| Next unblocked batch | `G11-P1-B3` after `G11-P1-B2` is pushed and remotely verified |
...
| Phase 1 — Unique mode systems | `InProgress` | Version 4.4 entry/module, Ordinary/Cyclical/Guide area closure, difficulties, layers, finish conditions, policy-bound carry/reset and Arithmetic Mapping catalogs/rules are normalized. Equations, Divergent Blessings, Curios/Grand Miracles/Hex, Golden Blood/Titan, protocols, services and progression remain. |
