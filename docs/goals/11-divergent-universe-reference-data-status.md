...
| Active batch | None |
| Next unblocked batch | `G11-P1-B6` after `G11-P1-B5` is pushed and remotely verified |
...
| Phase 1 — Unique mode systems | `InProgress` | Version 4.4 entry/module, stage closure, policy-bound carry/reset, Arithmetic Mapping, all 80 current Equations, all 414 current Blessings/828 levels, 179 Curio identities/235 copies and 17 Grand Miracles are normalized. Curio/Hex unavailable lifecycle fields are explicit and 57 historical eligibility rows are excluded by exact module join. Golden Blood/Titan, protocols, services and progression remain. |
