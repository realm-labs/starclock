...
| Goal 08 — Gold and Gears Reference Data | Version 4.4 Gold and Gears manifests, unique-mode mechanics, provenance, isolated Excel/Sora authoring and review fixtures; no runtime | Complete | [Plan](08-gold-and-gears-reference-data.md) | [Ledger](08-gold-and-gears-reference-data-status.md) | [Prompt](08-gold-and-gears-reference-data-prompt.md) |
