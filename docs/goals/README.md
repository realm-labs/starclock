...
| Goal 12 — Currency Wars Reference Data | Version 4.4 Currency Wars manifests, flow/Squad-HP/economy/roster/star/Bond/Empowerment mechanics, provenance, isolated Excel/Sora authoring and review fixtures; no runtime | Ready; may run parallel to Goals 07 through 11 in an isolated worktree | [Plan](12-currency-wars-reference-data.md) | [Ledger](12-currency-wars-reference-data-status.md) | [Prompt](12-currency-wars-reference-data-prompt.md) |
