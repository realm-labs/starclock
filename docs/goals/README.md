...
| Goal 07 — Complete Standard Universe Mechanics | Complete all released Version 4.4 Standard Universe combat/noncombat rules, enemies and encounter behavior after Goal 06 | Ready | [Plan](07-standard-universe-mechanics-completion.md) | [Ledger](07-standard-universe-mechanics-completion-status.md) | [Prompt](07-standard-universe-mechanics-completion-prompt.md) |
