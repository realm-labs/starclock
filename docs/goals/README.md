...
| Goal 14 — Memory of Chaos Reference Data | Version 4.4 active-season manifests, stage/Tierce flow, participant/loadout locks, clocks, objectives, Memory Turbulence, encounters, provenance and isolated Excel/Sora review fixtures; no runtime | Ready | [Plan](14-memory-of-chaos-reference-data.md) | [Ledger](14-memory-of-chaos-reference-data-status.md) | [Prompt](14-memory-of-chaos-reference-data-prompt.md) |
