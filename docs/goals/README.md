...
| Goal 06 — Combat Identity and Dynamic Per-Battle Assembly | Combat-owned input identity, replay v3 and current-Activity per-battle Standard Universe assembly without completing retained content mechanics | In progress | [Plan](06-combat-identity-and-dynamic-assembly.md) | [Ledger](06-combat-identity-and-dynamic-assembly-status.md) | [Prompt](06-combat-identity-and-dynamic-assembly-prompt.md) |
