...
| Goal 05 — Standard Universe End-to-End Integration | Real nested combat, atomic run effects, composed registries, logical domain scope and component-aware replay over the Goal 04 Standard SU release | In progress | [Plan](05-standard-universe-end-to-end.md) | [Ledger](05-standard-universe-end-to-end-status.md) | [Prompt](05-standard-universe-end-to-end-prompt.md) |
