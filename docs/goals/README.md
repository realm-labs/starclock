...
| Goal 06 — Combat Identity and Dynamic Per-Battle Assembly | Combat-owned input identity, replay v3 and current-Activity per-battle Standard Universe assembly without completing retained content mechanics | Complete; snapshot registration follows the release commit | [Plan](06-combat-identity-and-dynamic-assembly.md) | [Ledger](06-combat-identity-and-dynamic-assembly-status.md) | [Prompt](06-combat-identity-and-dynamic-assembly-prompt.md) |
| Goal 07 — Complete Standard Universe Mechanics | Complete all released Version 4.4 Standard Universe combat/noncombat rules, enemies and encounter behavior after Goal 06 | Awaiting Goal 06 snapshot registration | [Plan](07-standard-universe-mechanics-completion.md) | [Ledger](07-standard-universe-mechanics-completion-status.md) | [Prompt](07-standard-universe-mechanics-completion-prompt.md) |
