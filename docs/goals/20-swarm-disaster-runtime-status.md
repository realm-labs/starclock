...
| Active batch | None |
| Next unblocked batch | `G20-P1-B4` |
...
| Phase 1 — Bundle and catalogs | `InProgress` | `G20-P1-B1` loads the exact private bundle; `G20-P1-B2` freezes identities; `G20-P1-B3` lowers the profile/topology catalog and validates 101 static graph supersets. |
