...
| Active batch | None |
| Next unblocked batch | `G20-P1-B5` |
...
| Phase 1 — Bundle and catalogs | `InProgress` | `G20-P1-B1` loads the exact private bundle; `G20-P1-B2` freezes identities; `G20-P1-B3` lowers topology; `G20-P1-B4` lowers the 24-table unique-system catalog. |
