...
| Current batch | `G12-P1-B5` — Import Bonds, levels and contributions |
| Next unblocked batch | None until `G12-P1-B5` is committed, pushed and remotely verified |
...
| `G12-P1-B5` | `InProgress` | — | Imported 854 normalized rows (`739f6f99…16166f`): 33 Bonds, 16 sub-traits, 152 levels and 653 typed contributions with complete direct membership edges. Awaiting evidence ledger, final gates, atomic commit, push and remote SHA verification. |
