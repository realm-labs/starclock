...
| Current batch | `G12-P1-B3` — Import roster and economy |
| Next unblocked batch | None until `G12-P1-B3` is committed, pushed and remotely verified |
...
| `G12-P1-B3` | `InProgress` | — | Imported 103 normalized rows (`491cf889…28a9c`): all 77 GridFight roles, ten level-dependent offer pools, five exact buy/sell price tiers, one economy rule and ten roster/team-size states. Awaiting evidence ledger, final gates, atomic commit, push and remote SHA verification. |
...
| Positions/Character Empowerments | 6,645 | 0 | 0 | Includes all front/back position, skill, servant and battle-override rows. |
