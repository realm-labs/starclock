...
| Current batch | None; `G12-P1-B1` awaits publication of this ledger row |
| Next unblocked batch | `G12-P1-B2`, only after the `G12-P1-B1` commit is pushed and remotely resolved |
...
| Phase 1 — Unique mode systems | `InProgress` | Currency Wars identity, Standard/Overclock Gambits, Tourn3 areas/difficulties/layers, sixty exact Persona Nodes, Domain-composition seeds, finish conditions and policy-bound carry/reset are normalized. Squad HP/action value, economy, roster/shop/star, positioning/Empowerment, Bonds, builds, remaining Persona and rank data remain. |
