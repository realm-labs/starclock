...
| Current batch | `G12-P1-B6` — Import star states and lifecycle |
| Next unblocked batch | None until `G12-P1-B6` is committed, pushed and remotely verified |
...
| `G12-P1-B6` | `InProgress` | — | Imported 487 normalized rows (`0b1dce92…efb9b`): 266 role-star states, 29 servant-star states, all 1,596 rank attachments, 189 legal three-copy transitions and three policy-bound lifecycle rules. Awaiting evidence ledger, final gates, atomic commit, push and remote SHA verification. |
