...
| Active batch | — |
| Next unblocked batch | `G17-P2-B4` |
...
| `G17-R10` | `InProgress` | All 25 StageConfig encounters, 50 ordered waves, 99 slots, levels and difficulty bindings are exact. Concrete variant/template/ability dossiers, AI, summons and phases remain in P2-B4. | P2-B3–B4 | Close with complete encounter/enemy dossiers or an explicit nonblocking boundary for unavailable released evidence. |
