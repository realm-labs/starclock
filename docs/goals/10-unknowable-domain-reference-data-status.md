...
| Active batch | None |
| Next unblocked batch | `G10-P1-B5` |
...
| `G10-R06` | `Researching` | How do Component shape, slot/range, type, style and locked-Component constraints determine legal loadouts and insertion/removal? | P1-B5 | P1-B4 freezes all types/shapes, range compatibility, locked level identities and effect-program bindings. Replace the unresolved layout-validity and direct style fields with a complete source-backed legality matrix and positive/rejected semantic fixtures for every constraint class. |
