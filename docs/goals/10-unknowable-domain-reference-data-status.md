...
| Active batch | None |
| Next unblocked batch | `G10-P1-B3` |
...
| Phase 1 — Unique mode systems | `InProgress` | Profile/entry, 135 finish conditions, 13 areas, 97 difficulty rows, 32 layers, 176 positions, 1,518 rooms, policy-bounded flow/carry/reset rules and all four Extrapolation Alignments are normalized; later unique systems remain. |
