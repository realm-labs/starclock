...
| Active batch | — |
| Next unblocked batch | `G15-P3-B3` |
...
| Phase 3 — Independent Sora and Excel | `InProgress` | Fourteen core/mechanics Sora tables are generated; content-binding tables are next. |
