...
| Active batch | `G04-P3-B4` |
| Next unblocked batch | `G04-P3-B4` |
...
| `G04-P3-B2` | `Complete` | This row's containing commit | Added the generic `GraphActivity` runtime shell and compiled all 37 source topology templates into 579 spatial-free domain hubs. P3-B3 refined each hub into six bounded generic nodes, so the current topology has 3,479 nodes and 5,414 edges while retaining the same source topology/eligibility contract. Start consumes exactly one Graph-stream draw, offers all 9 Paths and never hashes coordinates. Graph golden: `6aeb6f31d5f15ac502f62227e2bb7342cb19b0b5d3e1c4de11eac4a0109bbce9`. |
| `G04-P3-B3` | `Complete` | This row's containing commit | Added deterministic room/member checkpoints over the Encounter RNG stream, exact primary room-content resolution for all 163 rooms, weighted selection across 173 encounter members, authored sequential waves/538 enemy slots, and generic mandatory/optional plus sequential/one-of slot semantics. A roster-specific immutable overlay supplies verified preparation variants and result contracts without exposing build fields. The integrated test consumes a legal encounter, normal engagement, immutable BattleSpec handoff, verified Won result, reward claim and gated route; a stale engage command preserves exact bytes. Reusable graph/program templates reduce all-33-profile compilation from about 69 seconds to about 3 seconds. Overlay golden: `a098a2294e872e98fe7933e5ed504daa12881f5f0c89046d61a19bc86e288f0c`; reward-state golden: `bfee5c6482ffef4443205f20ee48fdc86a6c90cbb686056cce06674028b8bf8c`. Full 73-enemy combat overlay remains P4-M15 and Blessing reward effects remain P3-B4. |
| `G04-P3-B4` | `Pending` | — | — |
| `G04-P3-B5` | `Pending` | — | — |
| `G04-P3-B6` | `Pending` | — | — |
| `G04-P3-B7` | `Pending` | — | — |
