...
| Active batch | `G04-P4-M03` |
| Next unblocked batch | `G04-P4-M03` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M02 close Ability Tree and the complete Preservation partition; thirteen partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 101 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 100 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 17 executable |
