...
| Active batch | `G04-P4-M08` |
| Next unblocked batch | `G04-P4-M08` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M07 close Ability Tree plus six complete Path partitions through Destruction; eight partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 396 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 390 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 30 executable |
