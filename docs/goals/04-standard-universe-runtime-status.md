...
| Active batch | `G04-P4-M07` |
| Next unblocked batch | `G04-P4-M07` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M06 close Ability Tree plus five complete Path partitions through Hunt; nine partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 337 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 332 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 29 executable |
