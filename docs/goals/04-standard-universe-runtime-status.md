...
| Active batch | `G04-P4-M10` |
| Next unblocked batch | `G04-P4-M10` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M09 close Ability Tree plus eight complete Path partitions through Propagation; six partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 514 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 506 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 35 executable |
