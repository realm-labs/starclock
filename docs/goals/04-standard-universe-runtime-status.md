...
| Active batch | `G04-P4-M11` |
| Next unblocked batch | `G04-P4-M11` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M10 close Ability Tree plus all nine Path partitions; five non-Path mechanic partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 573 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 564 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 37 executable |
...
| Curios / states | 61 / 67 | 61 / 67 assigned | 61 / 67 ownership/lifecycle/contribution-compiled; effect execution remains partitioned |
