...
| Active batch | `G04-P4-M05` |
| Next unblocked batch | `G04-P4-M05` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M04 close Ability Tree plus the complete Preservation, Remembrance and Nihility partitions; eleven partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 219 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 216 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 24 executable |
