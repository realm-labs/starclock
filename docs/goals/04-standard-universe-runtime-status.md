...
| Active batch | `G04-P4-M09` |
| Next unblocked batch | `G04-P4-M09` |
...
| Phase 4 — Mechanics | `InProgress` | M01–M08 close Ability Tree plus seven complete Path partitions through Elation; seven partitions remain. |
...
|---|---:|---:|---:|
| DataReady content records | 2,201 | 2,201 assigned | 455 executable |
| Mechanic-rule bindings | 786 | 786 assigned | 448 executable |
| Mechanic-family fixtures | 78 | 78 assigned | 32 executable |
