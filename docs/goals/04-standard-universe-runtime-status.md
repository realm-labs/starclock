...
| Active batch | `G04-P4-M01` |
| Next unblocked batch | `G04-P4-M01` |
...
| Ability Tree nodes / effects | 42 / 50 | 42 / 50 assigned | 42 / 50 canonical contribution-compiled; materialization remains P4-M01 |
...
| `G04-R06` | `Open` | Current ordinary reward offers use stable-uniform eligible candidates because the released source snapshot does not prove exact rarity/Path-biased drop probabilities. Replace only with versioned evidence and new goldens. | P4-M01 |
