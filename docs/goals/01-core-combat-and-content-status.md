...
| State | `InProgress` |
| Active phase | Phase 2 — Deterministic primitives |
| Next unblocked batch | `G01-P2-B4` |
| Last completed batch | `G01-P2-B3` |
...
| Phase 2 — Deterministic primitives | `InProgress` | B1 owns checked numeric policy `fixed-i64-6dp-v1`; B2 adds separate typed definition/runtime IDs and the deterministic immutable catalog; B3 binds SHA-256 substream derivation, pinned ChaCha8 raw words, project-owned unbiased range/weight mappings and explicit draw-consumption policy to `chacha8-rand-0.10.2-intmap-v1`. `G01-P2-B4` next. |
