...
| Last completed batch | `G01-P1-B1` |
...
| Phase 1 — Workspace and reproducible data foundation | `InProgress` | `G01-P1-B1` established the nine-crate virtual workspace and enforced exact dependency direction; `G01-P1-B2` next. |
