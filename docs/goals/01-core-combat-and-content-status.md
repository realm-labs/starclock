...
| Next unblocked batch | `G01-P2-B2` |
| Last completed batch | `G01-P2-B1` |
...
| Phase 2 — Deterministic primitives | `InProgress` | `G01-P2-B1` implements numeric policy `fixed-i64-6dp-v1` with private fixed-point storage, Starclock domain wrappers, six explicit rounding modes, typed faults, native/alternate-CPU vectors and mechanical no-authoritative-float enforcement; `G01-P2-B2` next. |
