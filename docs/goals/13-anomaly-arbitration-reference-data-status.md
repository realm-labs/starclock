...
|---|---:|---:|---:|---|
| Profile/period/entry/terminal outcomes | 20 | 0 | 0 | One profile, one active period, 14 entry/lifecycle constants and four terminal outcome obligations; groups 1–7 are excluded. |
| Stages/attempts/current-best progress | 16 | 0 | 0 | Ten stage/difficulty source rows plus six record/current-best lifecycle obligations. |
