...
| Active batch | `G13-P1-B1` complete pending this commit's publication |
| Next unblocked batch | `G13-P1-B2` after remote verification |
...
| Stages/attempts/current-best progress | 16 | 10 | 10 | Four aliases, five StageConfig parents and the Plight difficulty row are DataReady; six record/current-best lifecycle obligations remain. |
| Participant/team/loadout records | 4 | 0 | 0 | Three slots and character/form, Light Cone and Relic-instance uniqueness obligations. |
