...
impl super::runtime::SoraDecode for GoldGearsRoom {
    fn decode(
...
#[derive(Debug, Clone)]
pub struct GoldGearsRoomTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, GoldGearsRoom>,
    by_stable_key: SoraMap<String, i32>,
}

impl GoldGearsRoomTable {
    pub const NAME: &'static str = "GoldGearsRoom";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "GoldGearsRoom",
    ...
    pub fn get(&self, key: &i32) -> Option<&GoldGearsRoom> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &GoldGearsRoom> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&GoldGearsRoom> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for GoldGearsRoomTable {
    type Target = SoraMap<i32, GoldGearsRoom>;
...
impl super::ErasedSoraTable for GoldGearsRoomTable {
...
impl super::SoraKeyedTable for GoldGearsRoomTable {
    type Key = i32;
    type Row = GoldGearsRoom;
