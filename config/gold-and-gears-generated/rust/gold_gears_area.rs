...
impl super::runtime::SoraDecode for GoldGearsArea {
    fn decode(
...
#[derive(Debug, Clone)]
pub struct GoldGearsAreaTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, GoldGearsArea>,
    by_stable_key: SoraMap<String, i32>,
}

impl GoldGearsAreaTable {
    pub const NAME: &'static str = "GoldGearsArea";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "GoldGearsArea",
    ...
    pub fn get(&self, key: &i32) -> Option<&GoldGearsArea> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &GoldGearsArea> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&GoldGearsArea> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for GoldGearsAreaTable {
    type Target = SoraMap<i32, GoldGearsArea>;
...
impl super::ErasedSoraTable for GoldGearsAreaTable {
...
impl super::SoraKeyedTable for GoldGearsAreaTable {
    type Key = i32;
    type Row = GoldGearsArea;
