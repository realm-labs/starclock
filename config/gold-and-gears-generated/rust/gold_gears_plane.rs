...
impl super::runtime::SoraDecode for GoldGearsPlane {
    fn decode(
...
#[derive(Debug, Clone)]
pub struct GoldGearsPlaneTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, GoldGearsPlane>,
    by_stable_key: SoraMap<String, i32>,
}

impl GoldGearsPlaneTable {
    pub const NAME: &'static str = "GoldGearsPlane";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "GoldGearsPlane",
    ...
    pub fn get(&self, key: &i32) -> Option<&GoldGearsPlane> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &GoldGearsPlane> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&GoldGearsPlane> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for GoldGearsPlaneTable {
    type Target = SoraMap<i32, GoldGearsPlane>;
...
impl super::ErasedSoraTable for GoldGearsPlaneTable {
...
impl super::SoraKeyedTable for GoldGearsPlaneTable {
    type Key = i32;
    type Row = GoldGearsPlane;
