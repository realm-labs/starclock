...
impl super::runtime::SoraDecode for GoldGearsDomain {
    fn decode(
...
#[derive(Debug, Clone)]
pub struct GoldGearsDomainTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, GoldGearsDomain>,
    by_stable_key: SoraMap<String, i32>,
}

impl GoldGearsDomainTable {
    pub const NAME: &'static str = "GoldGearsDomain";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "GoldGearsDomain",
    ...
    pub fn get(&self, key: &i32) -> Option<&GoldGearsDomain> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &GoldGearsDomain> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&GoldGearsDomain> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for GoldGearsDomainTable {
    type Target = SoraMap<i32, GoldGearsDomain>;
...
impl super::ErasedSoraTable for GoldGearsDomainTable {
...
impl super::SoraKeyedTable for GoldGearsDomainTable {
    type Key = i32;
    type Row = GoldGearsDomain;
