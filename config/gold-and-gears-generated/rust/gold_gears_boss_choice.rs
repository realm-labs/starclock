...
pub struct GoldGearsBossChoice {
    #[serde(rename = "id")]
    pub id: i32,
...
#[derive(Debug, Clone)]
pub struct GoldGearsBossChoiceTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, GoldGearsBossChoice>,
    by_stable_key: SoraMap<String, i32>,
}

impl GoldGearsBossChoiceTable {
    pub const NAME: &'static str = "GoldGearsBossChoice";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "GoldGearsBossChoice",
    ...
    pub fn get(&self, key: &i32) -> Option<&GoldGearsBossChoice> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &GoldGearsBossChoice> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&GoldGearsBossChoice> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for GoldGearsBossChoiceTable {
    type Target = SoraMap<i32, GoldGearsBossChoice>;
...
impl super::ErasedSoraTable for GoldGearsBossChoiceTable {
...
impl super::SoraKeyedTable for GoldGearsBossChoiceTable {
    type Key = i32;
    type Row = GoldGearsBossChoice;
