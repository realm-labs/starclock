...
#[derive(Debug, Clone)]
pub struct GoldGearsBeaconTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, GoldGearsBeacon>,
    by_stable_key: SoraMap<String, i32>,
}

impl GoldGearsBeaconTable {
    pub const NAME: &'static str = "GoldGearsBeacon";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "GoldGearsBeacon",
    ...
    pub fn get(&self, key: &i32) -> Option<&GoldGearsBeacon> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &GoldGearsBeacon> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&GoldGearsBeacon> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for GoldGearsBeaconTable {
    type Target = SoraMap<i32, GoldGearsBeacon>;
...
impl super::ErasedSoraTable for GoldGearsBeaconTable {
...
impl super::SoraKeyedTable for GoldGearsBeaconTable {
    type Key = i32;
    type Row = GoldGearsBeacon;
