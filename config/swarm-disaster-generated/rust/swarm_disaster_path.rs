...
pub struct SwarmDisasterPath {
    ...
    #[serde(rename = "shared_path_id")]
    pub shared_path_id: String,
    ...
    pub formation_ids: Option<Vec<String>>,
    #[serde(rename = "battle_event_groups_json")]
    pub battle_event_groups_json: String,
    #[serde(rename = "extra_effect_ids")]
    pub extra_effect_ids: Option<Vec<String>>,
}

impl super::runtime::SoraDecode for SwarmDisasterPath {
    fn decode(
        ...
        Ok(Self {
            ...
            shared_path_id: <String as super::runtime::SoraDecode>::decode(reader)?,
            ...
            extra_effect_ids: <Option<Vec<String>> as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl SwarmDisasterPath {
...
#[derive(Debug, Clone)]
pub struct SwarmDisasterPathTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, SwarmDisasterPath>,
    by_stable_key: SoraMap<String, i32>,
}

impl SwarmDisasterPathTable {
    pub const NAME: &'static str = "SwarmDisasterPath";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "SwarmDisasterPath",
    ...
    pub fn get(&self, key: &i32) -> Option<&SwarmDisasterPath> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &SwarmDisasterPath> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&SwarmDisasterPath> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for SwarmDisasterPathTable {
    type Target = SoraMap<i32, SwarmDisasterPath>;
...
impl super::ErasedSoraTable for SwarmDisasterPathTable {
...
impl super::SoraKeyedTable for SwarmDisasterPathTable {
    type Key = i32;
    type Row = SwarmDisasterPath;
