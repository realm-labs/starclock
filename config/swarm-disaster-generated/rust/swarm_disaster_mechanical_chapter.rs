...
pub struct SwarmDisasterMechanicalChapter {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for SwarmDisasterMechanicalChapter {
    fn decode(
...
impl SwarmDisasterMechanicalChapter {
...
#[derive(Debug, Clone)]
pub struct SwarmDisasterMechanicalChapterTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, SwarmDisasterMechanicalChapter>,
    by_stable_key: SoraMap<String, i32>,
}

impl SwarmDisasterMechanicalChapterTable {
    pub const NAME: &'static str = "SwarmDisasterMechanicalChapter";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "SwarmDisasterMechanicalChapter",
    ...
    pub(super) fn from_rows(
        rows: Vec<SwarmDisasterMechanicalChapter>,
    ) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&SwarmDisasterMechanicalChapter> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &SwarmDisasterMechanicalChapter> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&SwarmDisasterMechanicalChapter> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for SwarmDisasterMechanicalChapterTable {
    type Target = SoraMap<i32, SwarmDisasterMechanicalChapter>;
...
impl super::ErasedSoraTable for SwarmDisasterMechanicalChapterTable {
...
impl super::SoraKeyedTable for SwarmDisasterMechanicalChapterTable {
    type Key = i32;
    type Row = SwarmDisasterMechanicalChapter;
