...
pub struct SwarmDisasterPathObjective {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for SwarmDisasterPathObjective {
    fn decode(
...
impl SwarmDisasterPathObjective {
...
#[derive(Debug, Clone)]
pub struct SwarmDisasterPathObjectiveTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, SwarmDisasterPathObjective>,
    by_stable_key: SoraMap<String, i32>,
}

impl SwarmDisasterPathObjectiveTable {
    pub const NAME: &'static str = "SwarmDisasterPathObjective";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "SwarmDisasterPathObjective",
    ...
    pub(super) fn from_rows(
        rows: Vec<SwarmDisasterPathObjective>,
    ) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&SwarmDisasterPathObjective> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &SwarmDisasterPathObjective> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&SwarmDisasterPathObjective> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for SwarmDisasterPathObjectiveTable {
    type Target = SoraMap<i32, SwarmDisasterPathObjective>;
...
impl super::ErasedSoraTable for SwarmDisasterPathObjectiveTable {
...
impl super::SoraKeyedTable for SwarmDisasterPathObjectiveTable {
    type Key = i32;
    type Row = SwarmDisasterPathObjective;
