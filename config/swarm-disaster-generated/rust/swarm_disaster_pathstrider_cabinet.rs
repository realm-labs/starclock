...
pub struct SwarmDisasterPathstriderCabinet {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for SwarmDisasterPathstriderCabinet {
    fn decode(
        ...
        Ok(Self {
            ...
            cabinet_type: <String as super::runtime::SoraDecode>::decode(reader)?,
...
impl SwarmDisasterPathstriderCabinet {
...
#[derive(Debug, Clone)]
pub struct SwarmDisasterPathstriderCabinetTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, SwarmDisasterPathstriderCabinet>,
    by_stable_key: SoraMap<String, i32>,
}

impl SwarmDisasterPathstriderCabinetTable {
    pub const NAME: &'static str = "SwarmDisasterPathstriderCabinet";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "SwarmDisasterPathstriderCabinet",
    ...
    pub(super) fn from_rows(
        rows: Vec<SwarmDisasterPathstriderCabinet>,
    ) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&SwarmDisasterPathstriderCabinet> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &SwarmDisasterPathstriderCabinet> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&SwarmDisasterPathstriderCabinet> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for SwarmDisasterPathstriderCabinetTable {
    type Target = SoraMap<i32, SwarmDisasterPathstriderCabinet>;
...
impl super::ErasedSoraTable for SwarmDisasterPathstriderCabinetTable {
...
impl super::SoraKeyedTable for SwarmDisasterPathstriderCabinetTable {
    type Key = i32;
    type Row = SwarmDisasterPathstriderCabinet;
