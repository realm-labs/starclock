...
impl super::runtime::SoraDecode for HitPlanHit {
    fn decode(
        ...
        Ok(Self {
            ...
            damage_parameter_key_override: match reader.read_u8()? {
                0 => None,
            ...
            damage_operation_ratio_decimal: match reader.read_u8()? {
                0 => None,
                1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?),
                value => {
                    return Err(super::runtime::SoraReadError::new(format!(
            ...
            toughness_amount_decimal: match reader.read_u8()? {
                0 => None,
                1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?),
                value => {
                    return Err(super::runtime::SoraReadError::new(format!(
            ...
            ignores_weakness: match reader.read_u8()? {
                0 => None,
                1 => Some(<bool as super::runtime::SoraDecode>::decode(reader)?),
                value => {
                    return Err(super::runtime::SoraReadError::new(format!(
                        "invalid option presence {}",
                        value
