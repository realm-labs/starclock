...
pub struct UnknowableDomainTalent {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "display_group_id")]
    pub display_group_id: String,
}

impl super::runtime::SoraDecode for UnknowableDomainTalent {
    fn decode(
        ...
        Ok(Self {
            ...
            display_group_id: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl UnknowableDomainTalent {
...
#[derive(Debug, Clone)]
pub struct UnknowableDomainTalentTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, UnknowableDomainTalent>,
    by_stable_key: SoraMap<String, i32>,
}

impl UnknowableDomainTalentTable {
    pub const NAME: &'static str = "UnknowableDomainTalent";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "UnknowableDomainTalent",
    ...
    pub(super) fn from_rows(
        rows: Vec<UnknowableDomainTalent>,
    ) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&UnknowableDomainTalent> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &UnknowableDomainTalent> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&UnknowableDomainTalent> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for UnknowableDomainTalentTable {
    type Target = SoraMap<i32, UnknowableDomainTalent>;
...
impl super::ErasedSoraTable for UnknowableDomainTalentTable {
...
impl super::SoraKeyedTable for UnknowableDomainTalentTable {
    type Key = i32;
    type Row = UnknowableDomainTalent;
