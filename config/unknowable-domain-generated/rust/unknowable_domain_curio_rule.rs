...
pub struct UnknowableDomainCurioRule {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "curio_group_id")]
    pub curio_group_id: Option<i32>,
    #[serde(rename = "trigger")]
    pub trigger: String,
    #[serde(rename = "lifecycle_json")]
    pub lifecycle_json: String,
    #[serde(rename = "repair_json")]
    pub repair_json: String,
...
impl super::runtime::SoraDecode for UnknowableDomainCurioRule {
    fn decode(
        ...
        Ok(Self {
            ...
            curio_group_id: <Option<i32> as super::runtime::SoraDecode>::decode(reader)?,
...
impl UnknowableDomainCurioRule {
...
#[derive(Debug, Clone)]
pub struct UnknowableDomainCurioRuleTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, UnknowableDomainCurioRule>,
    by_stable_key: SoraMap<String, i32>,
}

impl UnknowableDomainCurioRuleTable {
    pub const NAME: &'static str = "UnknowableDomainCurioRule";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "UnknowableDomainCurioRule",
    ...
    pub(super) fn from_rows(
        rows: Vec<UnknowableDomainCurioRule>,
    ) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&UnknowableDomainCurioRule> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &UnknowableDomainCurioRule> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&UnknowableDomainCurioRule> {
        self.by_stable_key
            .get(stable_key)
...
impl std::ops::Deref for UnknowableDomainCurioRuleTable {
    type Target = SoraMap<i32, UnknowableDomainCurioRule>;
...
impl super::ErasedSoraTable for UnknowableDomainCurioRuleTable {
...
impl super::SoraKeyedTable for UnknowableDomainCurioRuleTable {
    type Key = i32;
    type Row = UnknowableDomainCurioRule;
