...
pub struct DivergentUniverseSemanticFixtureFamilies {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseSemanticFixtureFamilies {
...
impl DivergentUniverseSemanticFixtureFamilies {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseSemanticFixtureFamiliesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseSemanticFixtureFamilies>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseSemanticFixtureFamiliesTable {
    pub const NAME: &'static str = "DivergentUniverseSemanticFixtureFamilies";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseSemanticFixtureFamilies",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseSemanticFixtureFamilies>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseSemanticFixtureFamilies> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseSemanticFixtureFamilies> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseSemanticFixtureFamilies> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseSemanticFixtureFamiliesTable {
    type Target = SoraMap<i32, DivergentUniverseSemanticFixtureFamilies>;
...
impl super::ErasedSoraTable for DivergentUniverseSemanticFixtureFamiliesTable {
...
impl super::SoraKeyedTable for DivergentUniverseSemanticFixtureFamiliesTable {
    type Key = i32;
    type Row = DivergentUniverseSemanticFixtureFamilies;
