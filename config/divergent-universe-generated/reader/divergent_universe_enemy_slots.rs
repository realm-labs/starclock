...
pub struct DivergentUniverseEnemySlots {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseEnemySlots {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            wave_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseEnemySlots {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEnemySlotsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEnemySlots>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEnemySlotsTable {
    pub const NAME: &'static str = "DivergentUniverseEnemySlots";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEnemySlots",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEnemySlots>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEnemySlots> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEnemySlots> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEnemySlots> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEnemySlotsTable {
    type Target = SoraMap<i32, DivergentUniverseEnemySlots>;
...
impl super::ErasedSoraTable for DivergentUniverseEnemySlotsTable {
...
impl super::SoraKeyedTable for DivergentUniverseEnemySlotsTable {
    type Key = i32;
    type Row = DivergentUniverseEnemySlots;
