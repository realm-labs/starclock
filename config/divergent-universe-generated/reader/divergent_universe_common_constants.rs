...
pub struct DivergentUniverseCommonConstants {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "canonical_value")]
    pub canonical_value: Option<String>,
    #[serde(rename = "consumer_ids")]
    pub consumer_ids: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseCommonConstants {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            value_kind: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            canonical_value: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            consumer_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseCommonConstants {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseCommonConstantsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseCommonConstants>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseCommonConstantsTable {
    pub const NAME: &'static str = "DivergentUniverseCommonConstants";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseCommonConstants",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseCommonConstants>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseCommonConstants> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseCommonConstants> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseCommonConstants> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseCommonConstantsTable {
    type Target = SoraMap<i32, DivergentUniverseCommonConstants>;
...
impl super::ErasedSoraTable for DivergentUniverseCommonConstantsTable {
...
impl super::SoraKeyedTable for DivergentUniverseCommonConstantsTable {
    type Key = i32;
    type Row = DivergentUniverseCommonConstants;
