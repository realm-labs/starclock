...
pub struct DivergentUniverseAstronomicalDivisions {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "division_level")]
    pub division_level: Option<String>,
    #[serde(rename = "progress_boundary")]
    pub progress_boundary: Option<String>,
...
impl super::runtime::SoraDecode for DivergentUniverseAstronomicalDivisions {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            division_level: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            progress_boundary: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseAstronomicalDivisions {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseAstronomicalDivisionsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseAstronomicalDivisions>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseAstronomicalDivisionsTable {
    pub const NAME: &'static str = "DivergentUniverseAstronomicalDivisions";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseAstronomicalDivisions",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseAstronomicalDivisions>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseAstronomicalDivisions> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseAstronomicalDivisions> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseAstronomicalDivisions> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseAstronomicalDivisionsTable {
    type Target = SoraMap<i32, DivergentUniverseAstronomicalDivisions>;
...
impl super::ErasedSoraTable for DivergentUniverseAstronomicalDivisionsTable {
...
impl super::SoraKeyedTable for DivergentUniverseAstronomicalDivisionsTable {
    type Key = i32;
    type Row = DivergentUniverseAstronomicalDivisions;
