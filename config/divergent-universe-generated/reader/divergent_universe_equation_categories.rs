...
pub struct DivergentUniverseEquationCategories {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "offer_rules")]
    pub offer_rules: Option<String>,
    #[serde(rename = "expansion_boundary")]
    pub expansion_boundary: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseEquationCategories {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            offer_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            expansion_boundary: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseEquationCategories {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEquationCategoriesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEquationCategories>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEquationCategoriesTable {
    pub const NAME: &'static str = "DivergentUniverseEquationCategories";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEquationCategories",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEquationCategories>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEquationCategories> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEquationCategories> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEquationCategories> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEquationCategoriesTable {
    type Target = SoraMap<i32, DivergentUniverseEquationCategories>;
...
impl super::ErasedSoraTable for DivergentUniverseEquationCategoriesTable {
...
impl super::SoraKeyedTable for DivergentUniverseEquationCategoriesTable {
    type Key = i32;
    type Row = DivergentUniverseEquationCategories;
