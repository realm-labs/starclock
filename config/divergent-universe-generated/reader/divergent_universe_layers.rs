...
pub struct DivergentUniverseLayers {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "ordered_room_position_ids")]
    pub ordered_room_position_ids: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseLayers {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            ordered_room_position_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseLayers {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseLayersTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseLayers>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseLayersTable {
    pub const NAME: &'static str = "DivergentUniverseLayers";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseLayers",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseLayers>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseLayers> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseLayers> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseLayers> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseLayersTable {
    type Target = SoraMap<i32, DivergentUniverseLayers>;
...
impl super::ErasedSoraTable for DivergentUniverseLayersTable {
...
impl super::SoraKeyedTable for DivergentUniverseLayersTable {
    type Key = i32;
    type Row = DivergentUniverseLayers;
