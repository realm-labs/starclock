...
pub struct DivergentUniverseCurios {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseCurios {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseCuriosTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseCurios>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseCuriosTable {
    pub const NAME: &'static str = "DivergentUniverseCurios";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseCurios",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseCurios>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseCurios> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseCurios> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseCurios> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseCuriosTable {
    type Target = SoraMap<i32, DivergentUniverseCurios>;
...
impl super::ErasedSoraTable for DivergentUniverseCuriosTable {
...
impl super::SoraKeyedTable for DivergentUniverseCuriosTable {
    type Key = i32;
    type Row = DivergentUniverseCurios;
