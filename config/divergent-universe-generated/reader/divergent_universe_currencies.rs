...
pub struct DivergentUniverseCurrencies {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "gain_rules")]
    pub gain_rules: Option<String>,
    #[serde(rename = "spend_rules")]
    pub spend_rules: Option<String>,
    #[serde(rename = "reset_rule")]
    pub reset_rule: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseCurrencies {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            gain_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            spend_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            reset_rule: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseCurrencies {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseCurrenciesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseCurrencies>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseCurrenciesTable {
    pub const NAME: &'static str = "DivergentUniverseCurrencies";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseCurrencies",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseCurrencies>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseCurrencies> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseCurrencies> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseCurrencies> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseCurrenciesTable {
    type Target = SoraMap<i32, DivergentUniverseCurrencies>;
...
impl super::ErasedSoraTable for DivergentUniverseCurrenciesTable {
...
impl super::SoraKeyedTable for DivergentUniverseCurrenciesTable {
    type Key = i32;
    type Row = DivergentUniverseCurrencies;
