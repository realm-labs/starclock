...
pub struct DivergentUniversePermanentTalents {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "adjacent_talent_ids")]
    pub adjacent_talent_ids: Option<Vec<i32>>,
    #[serde(rename = "cost")]
...
impl super::runtime::SoraDecode for DivergentUniversePermanentTalents {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            prerequisite_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            adjacent_talent_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            cost: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniversePermanentTalents {
...
#[derive(Debug, Clone)]
pub struct DivergentUniversePermanentTalentsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniversePermanentTalents>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniversePermanentTalentsTable {
    pub const NAME: &'static str = "DivergentUniversePermanentTalents";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniversePermanentTalents",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniversePermanentTalents>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniversePermanentTalents> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniversePermanentTalents> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniversePermanentTalents> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniversePermanentTalentsTable {
    type Target = SoraMap<i32, DivergentUniversePermanentTalents>;
...
impl super::ErasedSoraTable for DivergentUniversePermanentTalentsTable {
...
impl super::SoraKeyedTable for DivergentUniversePermanentTalentsTable {
    type Key = i32;
    type Row = DivergentUniversePermanentTalents;
