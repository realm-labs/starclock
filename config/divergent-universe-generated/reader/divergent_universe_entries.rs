...
pub struct DivergentUniverseEntries {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseEntries {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEntriesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEntries>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEntriesTable {
    pub const NAME: &'static str = "DivergentUniverseEntries";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEntries",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEntries>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEntries> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEntries> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEntries> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEntriesTable {
    type Target = SoraMap<i32, DivergentUniverseEntries>;
...
impl super::ErasedSoraTable for DivergentUniverseEntriesTable {
...
impl super::SoraKeyedTable for DivergentUniverseEntriesTable {
    type Key = i32;
    type Row = DivergentUniverseEntries;
