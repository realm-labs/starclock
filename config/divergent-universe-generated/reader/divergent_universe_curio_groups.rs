...
pub struct DivergentUniverseCurioGroups {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub candidate_state_ids: Option<String>,
...
impl super::runtime::SoraDecode for DivergentUniverseCurioGroups {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            candidate_state_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseCurioGroups {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseCurioGroupsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseCurioGroups>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseCurioGroupsTable {
    pub const NAME: &'static str = "DivergentUniverseCurioGroups";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseCurioGroups",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseCurioGroups>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseCurioGroups> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseCurioGroups> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseCurioGroups> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseCurioGroupsTable {
    type Target = SoraMap<i32, DivergentUniverseCurioGroups>;
...
impl super::ErasedSoraTable for DivergentUniverseCurioGroupsTable {
...
impl super::SoraKeyedTable for DivergentUniverseCurioGroupsTable {
    type Key = i32;
    type Row = DivergentUniverseCurioGroups;
