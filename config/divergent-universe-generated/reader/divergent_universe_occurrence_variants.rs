...
impl super::runtime::SoraDecode for DivergentUniverseOccurrenceVariants {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            occurrence_id: <Option<i32> as super::runtime::SoraDecode>::decode(reader)?,
            occurrence_ids: <Option<Vec<i32>> as super::runtime::SoraDecode>::decode(reader)?,
            choice_ids: <Option<Vec<i32>> as super::runtime::SoraDecode>::decode(reader)?,
