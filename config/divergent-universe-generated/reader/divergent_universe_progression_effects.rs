...
pub struct DivergentUniverseProgressionEffects {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseProgressionEffects {
...
impl DivergentUniverseProgressionEffects {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseProgressionEffectsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseProgressionEffects>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseProgressionEffectsTable {
    pub const NAME: &'static str = "DivergentUniverseProgressionEffects";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseProgressionEffects",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseProgressionEffects>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseProgressionEffects> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseProgressionEffects> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseProgressionEffects> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseProgressionEffectsTable {
    type Target = SoraMap<i32, DivergentUniverseProgressionEffects>;
...
impl super::ErasedSoraTable for DivergentUniverseProgressionEffectsTable {
...
impl super::SoraKeyedTable for DivergentUniverseProgressionEffectsTable {
    type Key = i32;
    type Row = DivergentUniverseProgressionEffects;
