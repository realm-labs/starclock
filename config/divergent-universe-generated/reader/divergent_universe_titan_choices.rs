...
pub struct DivergentUniverseTitanChoices {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "titan_type")]
    pub titan_type: Option<i32>,
    #[serde(rename = "candidate_ids")]
    pub candidate_ids: Option<Vec<i32>>,
    #[serde(rename = "eligibility")]
    pub eligibility: Option<String>,
    #[serde(rename = "selection_count")]
...
impl super::runtime::SoraDecode for DivergentUniverseTitanChoices {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            titan_type: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            candidate_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            selection_count: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseTitanChoices {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseTitanChoicesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseTitanChoices>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseTitanChoicesTable {
    pub const NAME: &'static str = "DivergentUniverseTitanChoices";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseTitanChoices",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseTitanChoices>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseTitanChoices> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseTitanChoices> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseTitanChoices> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseTitanChoicesTable {
    type Target = SoraMap<i32, DivergentUniverseTitanChoices>;
...
impl super::ErasedSoraTable for DivergentUniverseTitanChoicesTable {
...
impl super::SoraKeyedTable for DivergentUniverseTitanChoicesTable {
    type Key = i32;
    type Row = DivergentUniverseTitanChoices;
