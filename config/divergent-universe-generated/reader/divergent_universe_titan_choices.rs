...
impl super::runtime::SoraDecode for DivergentUniverseTitanChoices {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            titan_type: <Option<i32> as super::runtime::SoraDecode>::decode(reader)?,
            candidate_ids: <Option<Vec<i32>> as super::runtime::SoraDecode>::decode(reader)?,
            eligibility: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
            selection_count: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
