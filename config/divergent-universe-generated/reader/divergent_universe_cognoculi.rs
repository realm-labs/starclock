...
pub struct DivergentUniverseCognoculi {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseCognoculi {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            effect_scope: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseCognoculi {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseCognoculiTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseCognoculi>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseCognoculiTable {
    pub const NAME: &'static str = "DivergentUniverseCognoculi";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseCognoculi",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseCognoculi>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseCognoculi> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseCognoculi> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseCognoculi> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseCognoculiTable {
    type Target = SoraMap<i32, DivergentUniverseCognoculi>;
...
impl super::ErasedSoraTable for DivergentUniverseCognoculiTable {
...
impl super::SoraKeyedTable for DivergentUniverseCognoculiTable {
    type Key = i32;
    type Row = DivergentUniverseCognoculi;
