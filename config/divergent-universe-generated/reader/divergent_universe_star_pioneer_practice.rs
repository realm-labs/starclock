...
pub struct DivergentUniverseStarPioneerPractice {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "available_content")]
    pub available_content: Option<String>,
...
impl super::runtime::SoraDecode for DivergentUniverseStarPioneerPractice {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            available_content: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseStarPioneerPractice {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseStarPioneerPracticeTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseStarPioneerPractice>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseStarPioneerPracticeTable {
    pub const NAME: &'static str = "DivergentUniverseStarPioneerPractice";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseStarPioneerPractice",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseStarPioneerPractice>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseStarPioneerPractice> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseStarPioneerPractice> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseStarPioneerPractice> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseStarPioneerPracticeTable {
    type Target = SoraMap<i32, DivergentUniverseStarPioneerPractice>;
...
impl super::ErasedSoraTable for DivergentUniverseStarPioneerPracticeTable {
...
impl super::SoraKeyedTable for DivergentUniverseStarPioneerPracticeTable {
    type Key = i32;
    type Row = DivergentUniverseStarPioneerPractice;
