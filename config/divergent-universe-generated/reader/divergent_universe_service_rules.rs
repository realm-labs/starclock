...
pub struct DivergentUniverseServiceRules {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseServiceRules {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            currency_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            service_kind: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            price: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseServiceRules {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseServiceRulesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseServiceRules>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseServiceRulesTable {
    pub const NAME: &'static str = "DivergentUniverseServiceRules";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseServiceRules",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseServiceRules>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseServiceRules> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseServiceRules> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseServiceRules> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseServiceRulesTable {
    type Target = SoraMap<i32, DivergentUniverseServiceRules>;
...
impl super::ErasedSoraTable for DivergentUniverseServiceRulesTable {
...
impl super::SoraKeyedTable for DivergentUniverseServiceRulesTable {
    type Key = i32;
    type Row = DivergentUniverseServiceRules;
