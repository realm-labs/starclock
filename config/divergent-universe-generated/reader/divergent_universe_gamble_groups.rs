...
pub struct DivergentUniverseGambleGroups {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "offer_policy")]
    pub offer_policy: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseGambleGroups {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            group_type: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            unit_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            offer_policy: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseGambleGroups {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseGambleGroupsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseGambleGroups>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseGambleGroupsTable {
    pub const NAME: &'static str = "DivergentUniverseGambleGroups";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseGambleGroups",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseGambleGroups>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseGambleGroups> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseGambleGroups> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseGambleGroups> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseGambleGroupsTable {
    type Target = SoraMap<i32, DivergentUniverseGambleGroups>;
...
impl super::ErasedSoraTable for DivergentUniverseGambleGroupsTable {
...
impl super::SoraKeyedTable for DivergentUniverseGambleGroupsTable {
    type Key = i32;
    type Row = DivergentUniverseGambleGroups;
