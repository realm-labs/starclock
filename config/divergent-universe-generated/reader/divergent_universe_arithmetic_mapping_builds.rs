...
pub struct DivergentUniverseArithmeticMappingBuilds {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "role_buff_id")]
    pub role_buff_id: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseArithmeticMappingBuilds {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            role_buff_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseArithmeticMappingBuilds {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseArithmeticMappingBuildsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseArithmeticMappingBuilds>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseArithmeticMappingBuildsTable {
    pub const NAME: &'static str = "DivergentUniverseArithmeticMappingBuilds";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseArithmeticMappingBuilds",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseArithmeticMappingBuilds>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseArithmeticMappingBuilds> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseArithmeticMappingBuilds> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseArithmeticMappingBuilds> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseArithmeticMappingBuildsTable {
    type Target = SoraMap<i32, DivergentUniverseArithmeticMappingBuilds>;
...
impl super::ErasedSoraTable for DivergentUniverseArithmeticMappingBuildsTable {
...
impl super::SoraKeyedTable for DivergentUniverseArithmeticMappingBuildsTable {
    type Key = i32;
    type Row = DivergentUniverseArithmeticMappingBuilds;
