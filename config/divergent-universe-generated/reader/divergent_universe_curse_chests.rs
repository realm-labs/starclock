...
pub struct DivergentUniverseCurseChests {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseCurseChests {
...
impl DivergentUniverseCurseChests {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseCurseChestsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseCurseChests>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseCurseChestsTable {
    pub const NAME: &'static str = "DivergentUniverseCurseChests";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseCurseChests",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseCurseChests>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseCurseChests> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseCurseChests> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseCurseChests> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseCurseChestsTable {
    type Target = SoraMap<i32, DivergentUniverseCurseChests>;
...
impl super::ErasedSoraTable for DivergentUniverseCurseChestsTable {
...
impl super::SoraKeyedTable for DivergentUniverseCurseChestsTable {
    type Key = i32;
    type Row = DivergentUniverseCurseChests;
