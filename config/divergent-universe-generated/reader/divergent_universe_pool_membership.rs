...
pub struct DivergentUniversePoolMembership {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "membership_basis")]
    pub membership_basis: Option<String>,
    #[serde(rename = "module_scope")]
    pub module_scope: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniversePoolMembership {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            pool_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            member_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            membership_basis: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            module_scope: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniversePoolMembership {
...
#[derive(Debug, Clone)]
pub struct DivergentUniversePoolMembershipTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniversePoolMembership>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniversePoolMembershipTable {
    pub const NAME: &'static str = "DivergentUniversePoolMembership";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniversePoolMembership",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniversePoolMembership>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniversePoolMembership> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniversePoolMembership> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniversePoolMembership> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniversePoolMembershipTable {
    type Target = SoraMap<i32, DivergentUniversePoolMembership>;
...
impl super::ErasedSoraTable for DivergentUniversePoolMembershipTable {
...
impl super::SoraKeyedTable for DivergentUniversePoolMembershipTable {
    type Key = i32;
    type Row = DivergentUniversePoolMembership;
