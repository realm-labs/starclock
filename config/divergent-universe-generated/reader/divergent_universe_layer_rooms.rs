...
pub struct DivergentUniverseLayerRooms {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "room_index")]
    pub room_index: Option<String>,
    #[serde(rename = "door_program")]
    pub door_program: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseLayerRooms {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            layer_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            room_index: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            door_program: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseLayerRooms {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseLayerRoomsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseLayerRooms>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseLayerRoomsTable {
    pub const NAME: &'static str = "DivergentUniverseLayerRooms";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseLayerRooms",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseLayerRooms>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseLayerRooms> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseLayerRooms> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseLayerRooms> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseLayerRoomsTable {
    type Target = SoraMap<i32, DivergentUniverseLayerRooms>;
...
impl super::ErasedSoraTable for DivergentUniverseLayerRoomsTable {
...
impl super::SoraKeyedTable for DivergentUniverseLayerRoomsTable {
    type Key = i32;
    type Row = DivergentUniverseLayerRooms;
