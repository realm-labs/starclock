...
impl super::runtime::SoraDecode for DivergentUniverseLayerRooms {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            layer_id: <Option<i32> as super::runtime::SoraDecode>::decode(reader)?,
            room_index: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
            door_program: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
