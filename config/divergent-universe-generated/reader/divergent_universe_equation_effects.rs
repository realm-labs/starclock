...
pub struct DivergentUniverseEquationEffects {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "keyword_ids")]
    pub keyword_ids: Option<String>,
    #[serde(rename = "parameters")]
    pub parameters: Option<String>,
    #[serde(rename = "rule_contribution_ids")]
    pub rule_contribution_ids: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseEquationEffects {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            keyword_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            rule_contribution_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseEquationEffects {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEquationEffectsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEquationEffects>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEquationEffectsTable {
    pub const NAME: &'static str = "DivergentUniverseEquationEffects";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEquationEffects",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEquationEffects>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEquationEffects> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEquationEffects> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEquationEffects> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEquationEffectsTable {
    type Target = SoraMap<i32, DivergentUniverseEquationEffects>;
...
impl super::ErasedSoraTable for DivergentUniverseEquationEffectsTable {
...
impl super::SoraKeyedTable for DivergentUniverseEquationEffectsTable {
    type Key = i32;
    type Row = DivergentUniverseEquationEffects;
