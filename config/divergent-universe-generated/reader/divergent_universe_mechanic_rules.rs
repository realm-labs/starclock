...
pub struct DivergentUniverseMechanicRules {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub fixture_ids: Option<Vec<i32>>,
    #[serde(rename = "scope")]
...
impl super::runtime::SoraDecode for DivergentUniverseMechanicRules {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            source_file_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            fixture_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            scope: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            state_lifecycle: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            runtime_lowered: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseMechanicRules {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseMechanicRulesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseMechanicRules>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseMechanicRulesTable {
    pub const NAME: &'static str = "DivergentUniverseMechanicRules";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseMechanicRules",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseMechanicRules>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseMechanicRules> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseMechanicRules> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseMechanicRules> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseMechanicRulesTable {
    type Target = SoraMap<i32, DivergentUniverseMechanicRules>;
...
impl super::ErasedSoraTable for DivergentUniverseMechanicRulesTable {
...
impl super::SoraKeyedTable for DivergentUniverseMechanicRulesTable {
    type Key = i32;
    type Row = DivergentUniverseMechanicRules;
