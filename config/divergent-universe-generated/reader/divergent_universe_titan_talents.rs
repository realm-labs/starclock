...
pub struct DivergentUniverseTitanTalents {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "effect_program")]
    pub effect_program: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseTitanTalents {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            contribution_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            effect_program: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseTitanTalents {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseTitanTalentsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseTitanTalents>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseTitanTalentsTable {
    pub const NAME: &'static str = "DivergentUniverseTitanTalents";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseTitanTalents",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseTitanTalents>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseTitanTalents> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseTitanTalents> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseTitanTalents> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseTitanTalentsTable {
    type Target = SoraMap<i32, DivergentUniverseTitanTalents>;
...
impl super::ErasedSoraTable for DivergentUniverseTitanTalentsTable {
...
impl super::SoraKeyedTable for DivergentUniverseTitanTalentsTable {
    type Key = i32;
    type Row = DivergentUniverseTitanTalents;
