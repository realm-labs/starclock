...
pub struct DivergentUniverseBlessingLevels {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseBlessingLevels {
...
impl DivergentUniverseBlessingLevels {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseBlessingLevelsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseBlessingLevels>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseBlessingLevelsTable {
    pub const NAME: &'static str = "DivergentUniverseBlessingLevels";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseBlessingLevels",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseBlessingLevels>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseBlessingLevels> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseBlessingLevels> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseBlessingLevels> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseBlessingLevelsTable {
    type Target = SoraMap<i32, DivergentUniverseBlessingLevels>;
...
impl super::ErasedSoraTable for DivergentUniverseBlessingLevelsTable {
...
impl super::SoraKeyedTable for DivergentUniverseBlessingLevelsTable {
    type Key = i32;
    type Row = DivergentUniverseBlessingLevels;
