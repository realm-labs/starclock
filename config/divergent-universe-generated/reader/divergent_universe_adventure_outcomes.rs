...
pub struct DivergentUniverseAdventureOutcomes {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseAdventureOutcomes {
...
impl DivergentUniverseAdventureOutcomes {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseAdventureOutcomesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseAdventureOutcomes>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseAdventureOutcomesTable {
    pub const NAME: &'static str = "DivergentUniverseAdventureOutcomes";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseAdventureOutcomes",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseAdventureOutcomes>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseAdventureOutcomes> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseAdventureOutcomes> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseAdventureOutcomes> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseAdventureOutcomesTable {
    type Target = SoraMap<i32, DivergentUniverseAdventureOutcomes>;
...
impl super::ErasedSoraTable for DivergentUniverseAdventureOutcomesTable {
...
impl super::SoraKeyedTable for DivergentUniverseAdventureOutcomesTable {
    type Key = i32;
    type Row = DivergentUniverseAdventureOutcomes;
