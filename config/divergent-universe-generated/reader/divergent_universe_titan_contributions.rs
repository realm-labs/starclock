...
pub struct DivergentUniverseTitanContributions {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseTitanContributions {
...
impl DivergentUniverseTitanContributions {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseTitanContributionsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseTitanContributions>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseTitanContributionsTable {
    pub const NAME: &'static str = "DivergentUniverseTitanContributions";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseTitanContributions",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseTitanContributions>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseTitanContributions> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseTitanContributions> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseTitanContributions> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseTitanContributionsTable {
    type Target = SoraMap<i32, DivergentUniverseTitanContributions>;
...
impl super::ErasedSoraTable for DivergentUniverseTitanContributionsTable {
...
impl super::SoraKeyedTable for DivergentUniverseTitanContributionsTable {
    type Key = i32;
    type Row = DivergentUniverseTitanContributions;
