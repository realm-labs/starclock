...
pub struct DivergentUniverseUnlocks {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub finish_condition_id: Option<i32>,
    #[serde(rename = "unlocked_content_ids")]
    pub unlocked_content_ids: Option<String>,
    #[serde(rename = "scope")]
...
impl super::runtime::SoraDecode for DivergentUniverseUnlocks {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            finish_condition_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            unlocked_content_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseUnlocksTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseUnlocks>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseUnlocksTable {
    pub const NAME: &'static str = "DivergentUniverseUnlocks";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseUnlocks",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseUnlocks>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseUnlocks> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseUnlocks> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseUnlocks> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseUnlocksTable {
    type Target = SoraMap<i32, DivergentUniverseUnlocks>;
...
impl super::ErasedSoraTable for DivergentUniverseUnlocksTable {
...
impl super::SoraKeyedTable for DivergentUniverseUnlocksTable {
    type Key = i32;
    type Row = DivergentUniverseUnlocks;
