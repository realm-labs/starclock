...
pub struct DivergentUniverseGambleUnits {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub outcome_program: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseGambleUnits {
...
impl DivergentUniverseGambleUnits {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseGambleUnitsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseGambleUnits>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseGambleUnitsTable {
    pub const NAME: &'static str = "DivergentUniverseGambleUnits";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseGambleUnits",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseGambleUnits>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseGambleUnits> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseGambleUnits> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseGambleUnits> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseGambleUnitsTable {
    type Target = SoraMap<i32, DivergentUniverseGambleUnits>;
...
impl super::ErasedSoraTable for DivergentUniverseGambleUnitsTable {
...
impl super::SoraKeyedTable for DivergentUniverseGambleUnitsTable {
    type Key = i32;
    type Row = DivergentUniverseGambleUnits;
