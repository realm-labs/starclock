...
pub struct DivergentUniversePackIndex {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniversePackIndex {
...
impl DivergentUniversePackIndex {
...
#[derive(Debug, Clone)]
pub struct DivergentUniversePackIndexTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniversePackIndex>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniversePackIndexTable {
    pub const NAME: &'static str = "DivergentUniversePackIndex";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniversePackIndex",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniversePackIndex>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniversePackIndex> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniversePackIndex> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniversePackIndex> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniversePackIndexTable {
    type Target = SoraMap<i32, DivergentUniversePackIndex>;
...
impl super::ErasedSoraTable for DivergentUniversePackIndexTable {
...
impl super::SoraKeyedTable for DivergentUniversePackIndexTable {
    type Key = i32;
    type Row = DivergentUniversePackIndex;
