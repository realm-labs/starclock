...
pub struct DivergentUniverseWorkbenches {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub function_ids: Option<Vec<i32>>,
    #[serde(rename = "currency_ids")]
    pub currency_ids: Option<Vec<i32>>,
...
impl super::runtime::SoraDecode for DivergentUniverseWorkbenches {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            function_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            currency_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            availability: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseWorkbenches {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseWorkbenchesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseWorkbenches>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseWorkbenchesTable {
    pub const NAME: &'static str = "DivergentUniverseWorkbenches";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseWorkbenches",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseWorkbenches>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseWorkbenches> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseWorkbenches> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseWorkbenches> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseWorkbenchesTable {
    type Target = SoraMap<i32, DivergentUniverseWorkbenches>;
...
impl super::ErasedSoraTable for DivergentUniverseWorkbenchesTable {
...
impl super::SoraKeyedTable for DivergentUniverseWorkbenchesTable {
    type Key = i32;
    type Row = DivergentUniverseWorkbenches;
