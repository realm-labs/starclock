...
pub struct DivergentUniverseRooms {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseRooms {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            reachability_disposition: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            stage_refs: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseRooms {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseRoomsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseRooms>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseRoomsTable {
    pub const NAME: &'static str = "DivergentUniverseRooms";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseRooms",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseRooms>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseRooms> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseRooms> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseRooms> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseRoomsTable {
    type Target = SoraMap<i32, DivergentUniverseRooms>;
...
impl super::ErasedSoraTable for DivergentUniverseRoomsTable {
...
impl super::SoraKeyedTable for DivergentUniverseRoomsTable {
    type Key = i32;
    type Row = DivergentUniverseRooms;
