...
pub struct DivergentUniverseArithmeticMappingEligibility {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "account_comparison_policy")]
    pub account_comparison_policy: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseArithmeticMappingEligibility {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            account_comparison_policy: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseArithmeticMappingEligibility {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseArithmeticMappingEligibilityTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseArithmeticMappingEligibility>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseArithmeticMappingEligibilityTable {
    pub const NAME: &'static str = "DivergentUniverseArithmeticMappingEligibility";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseArithmeticMappingEligibility",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseArithmeticMappingEligibility>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseArithmeticMappingEligibility> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseArithmeticMappingEligibility> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseArithmeticMappingEligibility> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseArithmeticMappingEligibilityTable {
    type Target = SoraMap<i32, DivergentUniverseArithmeticMappingEligibility>;
...
impl super::ErasedSoraTable for DivergentUniverseArithmeticMappingEligibilityTable {
...
impl super::SoraKeyedTable for DivergentUniverseArithmeticMappingEligibilityTable {
    type Key = i32;
    type Row = DivergentUniverseArithmeticMappingEligibility;
