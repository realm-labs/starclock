...
pub struct DivergentUniverseBlessings {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseBlessings {
...
impl DivergentUniverseBlessings {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseBlessingsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseBlessings>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseBlessingsTable {
    pub const NAME: &'static str = "DivergentUniverseBlessings";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseBlessings",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseBlessings>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseBlessings> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseBlessings> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseBlessings> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseBlessingsTable {
    type Target = SoraMap<i32, DivergentUniverseBlessings>;
...
impl super::ErasedSoraTable for DivergentUniverseBlessingsTable {
...
impl super::SoraKeyedTable for DivergentUniverseBlessingsTable {
    type Key = i32;
    type Row = DivergentUniverseBlessings;
