...
pub struct DivergentUniverseOccurrences {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub variant_ids: Option<Vec<i32>>,
...
impl super::runtime::SoraDecode for DivergentUniverseOccurrences {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            variant_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            unlock_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseOccurrences {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseOccurrencesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseOccurrences>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseOccurrencesTable {
    pub const NAME: &'static str = "DivergentUniverseOccurrences";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseOccurrences",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseOccurrences>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseOccurrences> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseOccurrences> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseOccurrences> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseOccurrencesTable {
    type Target = SoraMap<i32, DivergentUniverseOccurrences>;
...
impl super::ErasedSoraTable for DivergentUniverseOccurrencesTable {
...
impl super::SoraKeyedTable for DivergentUniverseOccurrencesTable {
    type Key = i32;
    type Row = DivergentUniverseOccurrences;
