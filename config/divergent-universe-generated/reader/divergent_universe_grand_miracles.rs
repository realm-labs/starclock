...
pub struct DivergentUniverseGrandMiracles {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseGrandMiracles {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            display_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseGrandMiracles {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseGrandMiraclesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseGrandMiracles>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseGrandMiraclesTable {
    pub const NAME: &'static str = "DivergentUniverseGrandMiracles";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseGrandMiracles",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseGrandMiracles>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseGrandMiracles> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseGrandMiracles> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseGrandMiracles> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseGrandMiraclesTable {
    type Target = SoraMap<i32, DivergentUniverseGrandMiracles>;
...
impl super::ErasedSoraTable for DivergentUniverseGrandMiraclesTable {
...
impl super::SoraKeyedTable for DivergentUniverseGrandMiraclesTable {
    type Key = i32;
    type Row = DivergentUniverseGrandMiracles;
