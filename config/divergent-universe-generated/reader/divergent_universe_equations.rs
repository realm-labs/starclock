...
pub struct DivergentUniverseEquations {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub effect_ids: Option<Vec<i32>>,
    #[serde(rename = "category")]
    pub category: Option<String>,
    #[serde(rename = "main_path")]
    pub main_path: Option<String>,
    #[serde(rename = "sub_path")]
    pub sub_path: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseEquations {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            effect_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            main_path: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            sub_path: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseEquations {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEquationsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEquations>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEquationsTable {
    pub const NAME: &'static str = "DivergentUniverseEquations";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEquations",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEquations>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEquations> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEquations> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEquations> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEquationsTable {
    type Target = SoraMap<i32, DivergentUniverseEquations>;
...
impl super::ErasedSoraTable for DivergentUniverseEquationsTable {
...
impl super::SoraKeyedTable for DivergentUniverseEquationsTable {
    type Key = i32;
    type Row = DivergentUniverseEquations;
