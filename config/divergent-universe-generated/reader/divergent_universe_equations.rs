...
impl super::runtime::SoraDecode for DivergentUniverseEquations {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            effect_ids: <Option<Vec<i32>> as super::runtime::SoraDecode>::decode(reader)?,
            category: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
            main_path: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
            sub_path: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
