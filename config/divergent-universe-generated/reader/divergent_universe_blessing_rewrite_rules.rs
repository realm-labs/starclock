...
pub struct DivergentUniverseBlessingRewriteRules {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "input_blessing_id")]
    pub input_blessing_id: Option<i32>,
    #[serde(rename = "output_blessing_id")]
    pub output_blessing_id: Option<i32>,
...
impl super::runtime::SoraDecode for DivergentUniverseBlessingRewriteRules {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            input_blessing_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            output_blessing_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            timing: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseBlessingRewriteRules {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseBlessingRewriteRulesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseBlessingRewriteRules>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseBlessingRewriteRulesTable {
    pub const NAME: &'static str = "DivergentUniverseBlessingRewriteRules";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseBlessingRewriteRules",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseBlessingRewriteRules>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseBlessingRewriteRules> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseBlessingRewriteRules> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseBlessingRewriteRules> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseBlessingRewriteRulesTable {
    type Target = SoraMap<i32, DivergentUniverseBlessingRewriteRules>;
...
impl super::ErasedSoraTable for DivergentUniverseBlessingRewriteRulesTable {
...
impl super::SoraKeyedTable for DivergentUniverseBlessingRewriteRulesTable {
    type Key = i32;
    type Row = DivergentUniverseBlessingRewriteRules;
