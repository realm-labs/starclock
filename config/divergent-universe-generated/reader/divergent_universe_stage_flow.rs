...
pub struct DivergentUniverseStageFlow {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "ordered_stage_refs")]
    pub ordered_stage_refs: Option<String>,
...
impl super::runtime::SoraDecode for DivergentUniverseStageFlow {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            entry_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ordered_stage_refs: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            carry_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            reset_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseStageFlow {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseStageFlowTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseStageFlow>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseStageFlowTable {
    pub const NAME: &'static str = "DivergentUniverseStageFlow";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseStageFlow",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseStageFlow>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseStageFlow> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseStageFlow> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseStageFlow> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseStageFlowTable {
    type Target = SoraMap<i32, DivergentUniverseStageFlow>;
...
impl super::ErasedSoraTable for DivergentUniverseStageFlowTable {
...
impl super::SoraKeyedTable for DivergentUniverseStageFlowTable {
    type Key = i32;
    type Row = DivergentUniverseStageFlow;
