...
pub struct DivergentUniverseDifficulties {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseDifficulties {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            level_list: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            protocol_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseDifficulties {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseDifficultiesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseDifficulties>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseDifficultiesTable {
    pub const NAME: &'static str = "DivergentUniverseDifficulties";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseDifficulties",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseDifficulties>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseDifficulties> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseDifficulties> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseDifficulties> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseDifficultiesTable {
    type Target = SoraMap<i32, DivergentUniverseDifficulties>;
...
impl super::ErasedSoraTable for DivergentUniverseDifficultiesTable {
...
impl super::SoraKeyedTable for DivergentUniverseDifficultiesTable {
    type Key = i32;
    type Row = DivergentUniverseDifficulties;
