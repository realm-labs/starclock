...
pub struct DivergentUniverseGrandMiracleStates {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseGrandMiracleStates {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            duration: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseGrandMiracleStates {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseGrandMiracleStatesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseGrandMiracleStates>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseGrandMiracleStatesTable {
    pub const NAME: &'static str = "DivergentUniverseGrandMiracleStates";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseGrandMiracleStates",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseGrandMiracleStates>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseGrandMiracleStates> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseGrandMiracleStates> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseGrandMiracleStates> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseGrandMiracleStatesTable {
    type Target = SoraMap<i32, DivergentUniverseGrandMiracleStates>;
...
impl super::ErasedSoraTable for DivergentUniverseGrandMiracleStatesTable {
...
impl super::SoraKeyedTable for DivergentUniverseGrandMiracleStatesTable {
    type Key = i32;
    type Row = DivergentUniverseGrandMiracleStates;
