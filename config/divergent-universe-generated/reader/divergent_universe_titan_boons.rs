...
pub struct DivergentUniverseTitanBoons {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseTitanBoons {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            maze_buff_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseTitanBoons {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseTitanBoonsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseTitanBoons>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseTitanBoonsTable {
    pub const NAME: &'static str = "DivergentUniverseTitanBoons";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseTitanBoons",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseTitanBoons>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseTitanBoons> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseTitanBoons> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseTitanBoons> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseTitanBoonsTable {
    type Target = SoraMap<i32, DivergentUniverseTitanBoons>;
...
impl super::ErasedSoraTable for DivergentUniverseTitanBoonsTable {
...
impl super::SoraKeyedTable for DivergentUniverseTitanBoonsTable {
    type Key = i32;
    type Row = DivergentUniverseTitanBoons;
