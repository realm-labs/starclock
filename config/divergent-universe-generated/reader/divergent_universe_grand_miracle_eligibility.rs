...
pub struct DivergentUniverseGrandMiracleEligibility {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "grand_miracle_id")]
    pub grand_miracle_id: Option<i32>,
    #[serde(rename = "character_path")]
...
impl super::runtime::SoraDecode for DivergentUniverseGrandMiracleEligibility {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            grand_miracle_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            character_path: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            element: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseGrandMiracleEligibility {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseGrandMiracleEligibilityTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseGrandMiracleEligibility>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseGrandMiracleEligibilityTable {
    pub const NAME: &'static str = "DivergentUniverseGrandMiracleEligibility";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseGrandMiracleEligibility",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseGrandMiracleEligibility>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseGrandMiracleEligibility> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseGrandMiracleEligibility> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseGrandMiracleEligibility> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseGrandMiracleEligibilityTable {
    type Target = SoraMap<i32, DivergentUniverseGrandMiracleEligibility>;
...
impl super::ErasedSoraTable for DivergentUniverseGrandMiracleEligibilityTable {
...
impl super::SoraKeyedTable for DivergentUniverseGrandMiracleEligibilityTable {
    type Key = i32;
    type Row = DivergentUniverseGrandMiracleEligibility;
