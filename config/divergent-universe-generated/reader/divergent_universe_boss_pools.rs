...
pub struct DivergentUniverseBossPools {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "weekly_modifier_id")]
    pub weekly_modifier_id: Option<i32>,
...
impl super::runtime::SoraDecode for DivergentUniverseBossPools {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            weekly_modifier_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            encounter_group_id: match reader.read_u8()? { 0 => None, 1 => Some(<i32 as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            area_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            ...
            candidate_monster_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseBossPools {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseBossPoolsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseBossPools>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseBossPoolsTable {
    pub const NAME: &'static str = "DivergentUniverseBossPools";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseBossPools",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseBossPools>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseBossPools> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseBossPools> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseBossPools> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseBossPoolsTable {
    type Target = SoraMap<i32, DivergentUniverseBossPools>;
...
impl super::ErasedSoraTable for DivergentUniverseBossPoolsTable {
...
impl super::SoraKeyedTable for DivergentUniverseBossPoolsTable {
    type Key = i32;
    type Row = DivergentUniverseBossPools;
