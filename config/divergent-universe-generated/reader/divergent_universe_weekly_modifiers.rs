...
pub struct DivergentUniverseWeeklyModifiers {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "detail_ids")]
    pub detail_ids: Option<String>,
    #[serde(rename = "enemy_group_refs")]
    pub enemy_group_refs: Option<String>,
...
impl super::runtime::SoraDecode for DivergentUniverseWeeklyModifiers {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            content_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            detail_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            enemy_group_refs: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseWeeklyModifiers {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseWeeklyModifiersTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseWeeklyModifiers>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseWeeklyModifiersTable {
    pub const NAME: &'static str = "DivergentUniverseWeeklyModifiers";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseWeeklyModifiers",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseWeeklyModifiers>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseWeeklyModifiers> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseWeeklyModifiers> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseWeeklyModifiers> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseWeeklyModifiersTable {
    type Target = SoraMap<i32, DivergentUniverseWeeklyModifiers>;
...
impl super::ErasedSoraTable for DivergentUniverseWeeklyModifiersTable {
...
impl super::SoraKeyedTable for DivergentUniverseWeeklyModifiersTable {
    type Key = i32;
    type Row = DivergentUniverseWeeklyModifiers;
