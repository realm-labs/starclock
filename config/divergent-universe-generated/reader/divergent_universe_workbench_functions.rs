...
pub struct DivergentUniverseWorkbenchFunctions {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseWorkbenchFunctions {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            function_type: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            input_policy: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            output_policy: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            price_rule: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseWorkbenchFunctions {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseWorkbenchFunctionsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseWorkbenchFunctions>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseWorkbenchFunctionsTable {
    pub const NAME: &'static str = "DivergentUniverseWorkbenchFunctions";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseWorkbenchFunctions",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseWorkbenchFunctions>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseWorkbenchFunctions> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseWorkbenchFunctions> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseWorkbenchFunctions> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseWorkbenchFunctionsTable {
    type Target = SoraMap<i32, DivergentUniverseWorkbenchFunctions>;
...
impl super::ErasedSoraTable for DivergentUniverseWorkbenchFunctionsTable {
...
impl super::SoraKeyedTable for DivergentUniverseWorkbenchFunctionsTable {
    type Key = i32;
    type Row = DivergentUniverseWorkbenchFunctions;
