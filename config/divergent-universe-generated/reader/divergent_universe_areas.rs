...
impl super::runtime::SoraDecode for DivergentUniverseAreas {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            difficulty_ids: <Option<Vec<i32>> as super::runtime::SoraDecode>::decode(reader)?,
            layer_ids: <Option<Vec<i32>> as super::runtime::SoraDecode>::decode(reader)?,
            area_type: <Option<String> as super::runtime::SoraDecode>::decode(reader)?,
