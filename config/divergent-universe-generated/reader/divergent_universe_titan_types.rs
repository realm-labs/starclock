...
pub struct DivergentUniverseTitanTypes {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "boon_ids")]
    pub boon_ids: Option<String>,
    #[serde(rename = "talent_ids")]
    pub talent_ids: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseTitanTypes {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            boon_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            talent_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseTitanTypes {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseTitanTypesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseTitanTypes>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseTitanTypesTable {
    pub const NAME: &'static str = "DivergentUniverseTitanTypes";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseTitanTypes",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseTitanTypes>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseTitanTypes> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseTitanTypes> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseTitanTypes> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseTitanTypesTable {
    type Target = SoraMap<i32, DivergentUniverseTitanTypes>;
...
impl super::ErasedSoraTable for DivergentUniverseTitanTypesTable {
...
impl super::SoraKeyedTable for DivergentUniverseTitanTypesTable {
    type Key = i32;
    type Row = DivergentUniverseTitanTypes;
