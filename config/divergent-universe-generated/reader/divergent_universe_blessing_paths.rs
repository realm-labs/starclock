...
pub struct DivergentUniverseBlessingPaths {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "equation_roles")]
    pub equation_roles: Option<String>,
    #[serde(rename = "rewrite_rules")]
    pub rewrite_rules: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseBlessingPaths {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            equation_roles: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            rewrite_rules: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseBlessingPaths {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseBlessingPathsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseBlessingPaths>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseBlessingPathsTable {
    pub const NAME: &'static str = "DivergentUniverseBlessingPaths";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseBlessingPaths",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseBlessingPaths>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseBlessingPaths> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseBlessingPaths> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseBlessingPaths> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseBlessingPathsTable {
    type Target = SoraMap<i32, DivergentUniverseBlessingPaths>;
...
impl super::ErasedSoraTable for DivergentUniverseBlessingPathsTable {
...
impl super::SoraKeyedTable for DivergentUniverseBlessingPathsTable {
    type Key = i32;
    type Row = DivergentUniverseBlessingPaths;
