...
pub struct DivergentUniverseEquationExpansionStates {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    #[serde(rename = "entry_condition")]
    pub entry_condition: Option<String>,
    #[serde(rename = "exit_condition")]
    pub exit_condition: Option<String>,
    #[serde(rename = "payload_json")]
    pub payload_json: String,
}

impl super::runtime::SoraDecode for DivergentUniverseEquationExpansionStates {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            entry_condition: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            exit_condition: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            payload_json: <String as super::runtime::SoraDecode>::decode(reader)?,
        })
    }
}

impl DivergentUniverseEquationExpansionStates {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEquationExpansionStatesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEquationExpansionStates>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEquationExpansionStatesTable {
    pub const NAME: &'static str = "DivergentUniverseEquationExpansionStates";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEquationExpansionStates",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEquationExpansionStates>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEquationExpansionStates> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEquationExpansionStates> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEquationExpansionStates> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEquationExpansionStatesTable {
    type Target = SoraMap<i32, DivergentUniverseEquationExpansionStates>;
...
impl super::ErasedSoraTable for DivergentUniverseEquationExpansionStatesTable {
...
impl super::SoraKeyedTable for DivergentUniverseEquationExpansionStatesTable {
    type Key = i32;
    type Row = DivergentUniverseEquationExpansionStates;
