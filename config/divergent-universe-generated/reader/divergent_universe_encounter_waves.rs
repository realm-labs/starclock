...
pub struct DivergentUniverseEncounterWaves {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub enemy_slot_ids: Option<Vec<i32>>,
...
impl super::runtime::SoraDecode for DivergentUniverseEncounterWaves {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            enemy_slot_ids: match reader.read_u8()? { 0 => None, 1 => Some({ let len = reader.read_var_u32()? as usize; let mut values = Vec::with_capacity(len); for _ in 0..len { values.push(<i32 as super::runtime::SoraDecode>::decode(reader)?); } values }), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseEncounterWaves {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEncounterWavesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEncounterWaves>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEncounterWavesTable {
    pub const NAME: &'static str = "DivergentUniverseEncounterWaves";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEncounterWaves",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEncounterWaves>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEncounterWaves> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEncounterWaves> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEncounterWaves> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEncounterWavesTable {
    type Target = SoraMap<i32, DivergentUniverseEncounterWaves>;
...
impl super::ErasedSoraTable for DivergentUniverseEncounterWavesTable {
...
impl super::SoraKeyedTable for DivergentUniverseEncounterWavesTable {
    type Key = i32;
    type Row = DivergentUniverseEncounterWaves;
