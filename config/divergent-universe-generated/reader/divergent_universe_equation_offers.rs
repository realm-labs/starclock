...
pub struct DivergentUniverseEquationOffers {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for DivergentUniverseEquationOffers {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            weight_program: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            reroll_rule: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl DivergentUniverseEquationOffers {
...
#[derive(Debug, Clone)]
pub struct DivergentUniverseEquationOffersTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, DivergentUniverseEquationOffers>,
    by_stable_key: SoraMap<String, i32>,
}

impl DivergentUniverseEquationOffersTable {
    pub const NAME: &'static str = "DivergentUniverseEquationOffers";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "DivergentUniverseEquationOffers",
    ...
    pub(super) fn from_rows(rows: Vec<DivergentUniverseEquationOffers>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&DivergentUniverseEquationOffers> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &DivergentUniverseEquationOffers> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&DivergentUniverseEquationOffers> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for DivergentUniverseEquationOffersTable {
    type Target = SoraMap<i32, DivergentUniverseEquationOffers>;
...
impl super::ErasedSoraTable for DivergentUniverseEquationOffersTable {
...
impl super::SoraKeyedTable for DivergentUniverseEquationOffersTable {
    type Key = i32;
    type Row = DivergentUniverseEquationOffers;
