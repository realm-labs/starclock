...
impl super::runtime::SoraDecode for CurrencyWarsOrbs {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            bonus_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsOrbsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsOrbs>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsOrbsTable {
    pub const NAME: &'static str = "CurrencyWarsOrbs";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsOrbs",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsOrbs>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsOrbs> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsOrbs> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsOrbs> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsOrbsTable {
    type Target = SoraMap<i32, CurrencyWarsOrbs>;
...
impl super::ErasedSoraTable for CurrencyWarsOrbsTable {
...
impl super::SoraKeyedTable for CurrencyWarsOrbsTable {
    type Key = i32;
    type Row = CurrencyWarsOrbs;
