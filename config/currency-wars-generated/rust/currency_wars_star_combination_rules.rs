...
pub struct CurrencyWarsStarCombinationRules {
    #[serde(rename = "id")]
    pub id: i32,
...
impl CurrencyWarsStarCombinationRules {
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsStarCombinationRulesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsStarCombinationRules>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsStarCombinationRulesTable {
    pub const NAME: &'static str = "CurrencyWarsStarCombinationRules";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsStarCombinationRules",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsStarCombinationRules>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsStarCombinationRules> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsStarCombinationRules> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsStarCombinationRules> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsStarCombinationRulesTable {
    type Target = SoraMap<i32, CurrencyWarsStarCombinationRules>;
...
impl super::ErasedSoraTable for CurrencyWarsStarCombinationRulesTable {
...
impl super::SoraKeyedTable for CurrencyWarsStarCombinationRulesTable {
    type Key = i32;
    type Row = CurrencyWarsStarCombinationRules;
