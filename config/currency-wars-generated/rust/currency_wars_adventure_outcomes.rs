...
pub struct CurrencyWarsAdventureOutcomes {
    #[serde(rename = "id")]
    pub id: i32,
...
impl CurrencyWarsAdventureOutcomes {
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsAdventureOutcomesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsAdventureOutcomes>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsAdventureOutcomesTable {
    pub const NAME: &'static str = "CurrencyWarsAdventureOutcomes";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsAdventureOutcomes",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsAdventureOutcomes>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsAdventureOutcomes> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsAdventureOutcomes> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsAdventureOutcomes> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsAdventureOutcomesTable {
    type Target = SoraMap<i32, CurrencyWarsAdventureOutcomes>;
...
impl super::ErasedSoraTable for CurrencyWarsAdventureOutcomesTable {
...
impl super::SoraKeyedTable for CurrencyWarsAdventureOutcomesTable {
    type Key = i32;
    type Row = CurrencyWarsAdventureOutcomes;
