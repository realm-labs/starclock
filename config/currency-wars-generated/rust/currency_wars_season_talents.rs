...
pub struct CurrencyWarsSeasonTalents {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for CurrencyWarsSeasonTalents {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            prerequisite_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
            successor_ids: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl CurrencyWarsSeasonTalents {
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsSeasonTalentsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsSeasonTalents>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsSeasonTalentsTable {
    pub const NAME: &'static str = "CurrencyWarsSeasonTalents";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsSeasonTalents",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsSeasonTalents>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsSeasonTalents> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsSeasonTalents> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsSeasonTalents> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsSeasonTalentsTable {
    type Target = SoraMap<i32, CurrencyWarsSeasonTalents>;
...
impl super::ErasedSoraTable for CurrencyWarsSeasonTalentsTable {
...
impl super::SoraKeyedTable for CurrencyWarsSeasonTalentsTable {
    type Key = i32;
    type Row = CurrencyWarsSeasonTalents;
