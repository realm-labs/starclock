...
pub struct CurrencyWarsBuildSourceFiles {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for CurrencyWarsBuildSourceFiles {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            mapping_role: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl CurrencyWarsBuildSourceFiles {
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsBuildSourceFilesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsBuildSourceFiles>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsBuildSourceFilesTable {
    pub const NAME: &'static str = "CurrencyWarsBuildSourceFiles";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsBuildSourceFiles",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsBuildSourceFiles>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsBuildSourceFiles> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsBuildSourceFiles> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsBuildSourceFiles> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsBuildSourceFilesTable {
    type Target = SoraMap<i32, CurrencyWarsBuildSourceFiles>;
...
impl super::ErasedSoraTable for CurrencyWarsBuildSourceFilesTable {
...
impl super::SoraKeyedTable for CurrencyWarsBuildSourceFilesTable {
    type Key = i32;
    type Row = CurrencyWarsBuildSourceFiles;
