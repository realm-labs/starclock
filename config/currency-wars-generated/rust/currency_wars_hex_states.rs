...
pub struct CurrencyWarsHexStates {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for CurrencyWarsHexStates {
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsHexStatesTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsHexStates>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsHexStatesTable {
    pub const NAME: &'static str = "CurrencyWarsHexStates";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsHexStates",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsHexStates>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsHexStates> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsHexStates> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsHexStates> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsHexStatesTable {
    type Target = SoraMap<i32, CurrencyWarsHexStates>;
...
impl super::ErasedSoraTable for CurrencyWarsHexStatesTable {
...
impl super::SoraKeyedTable for CurrencyWarsHexStatesTable {
    type Key = i32;
    type Row = CurrencyWarsHexStates;
