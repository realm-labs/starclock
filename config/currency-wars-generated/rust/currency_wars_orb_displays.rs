...
pub struct CurrencyWarsOrbDisplays {
    #[serde(rename = "id")]
    pub id: i32,
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsOrbDisplaysTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsOrbDisplays>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsOrbDisplaysTable {
    pub const NAME: &'static str = "CurrencyWarsOrbDisplays";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsOrbDisplays",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsOrbDisplays>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsOrbDisplays> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsOrbDisplays> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsOrbDisplays> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsOrbDisplaysTable {
    type Target = SoraMap<i32, CurrencyWarsOrbDisplays>;
...
impl super::ErasedSoraTable for CurrencyWarsOrbDisplaysTable {
...
impl super::SoraKeyedTable for CurrencyWarsOrbDisplaysTable {
    type Key = i32;
    type Row = CurrencyWarsOrbDisplays;
