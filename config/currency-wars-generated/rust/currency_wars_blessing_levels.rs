...
pub struct CurrencyWarsBlessingLevels {
    #[serde(rename = "id")]
    pub id: i32,
...
impl super::runtime::SoraDecode for CurrencyWarsBlessingLevels {
    fn decode(reader: &mut super::runtime::SoraReader<'_>) -> Result<Self, super::runtime::SoraReadError> {
        Ok(Self {
            ...
            blessing_id: match reader.read_u8()? { 0 => None, 1 => Some(<String as super::runtime::SoraDecode>::decode(reader)?), value => return Err(super::runtime::SoraReadError::new(format!("invalid option presence {}", value))), },
...
impl CurrencyWarsBlessingLevels {
...
#[derive(Debug, Clone)]
pub struct CurrencyWarsBlessingLevelsTable {
    keys: Vec<i32>,
    rows: SoraMap<i32, CurrencyWarsBlessingLevels>,
    by_stable_key: SoraMap<String, i32>,
}

impl CurrencyWarsBlessingLevelsTable {
    pub const NAME: &'static str = "CurrencyWarsBlessingLevels";
    pub const INFO: super::SoraTableInfo = super::SoraTableInfo {
        name: Self::NAME,
        row_type: "CurrencyWarsBlessingLevels",
    ...
    pub(super) fn from_rows(rows: Vec<CurrencyWarsBlessingLevels>) -> Result<Self, super::runtime::SoraReadError> {
    ...
    pub fn get(&self, key: &i32) -> Option<&CurrencyWarsBlessingLevels> {
        self.rows.get(key)
    }
    ...
    pub fn ordered_rows(&self) -> impl Iterator<Item = &CurrencyWarsBlessingLevels> {
        self.keys.iter().filter_map(|key| self.rows.get(key))
    }
    pub fn get_by_stable_key(&self, stable_key: &str) -> Option<&CurrencyWarsBlessingLevels> {
        self.by_stable_key.get(stable_key).and_then(|key| self.rows.get(key))
    }
}

impl std::ops::Deref for CurrencyWarsBlessingLevelsTable {
    type Target = SoraMap<i32, CurrencyWarsBlessingLevels>;
...
impl super::ErasedSoraTable for CurrencyWarsBlessingLevelsTable {
...
impl super::SoraKeyedTable for CurrencyWarsBlessingLevelsTable {
    type Key = i32;
    type Row = CurrencyWarsBlessingLevels;
