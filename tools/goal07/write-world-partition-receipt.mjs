...
assert(partitionId === "G07-P5-M15-S19",
...
assert(partition?.lane === "domain-graph",
  `${partitionId}: not a domain-graph partition`);
...
const receipt = {
  ...
  records: partition.record_ids.map((id) => disposition(records.get(id))),
  rules: [],
  fixtures: [],
  enemy_variants: [],
  encounter_members: [],
