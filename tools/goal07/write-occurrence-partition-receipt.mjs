...
const isS14 = partitionId === "G07-P4-M13-S14";
...
const receipt = {
  ...
  state: "Complete",
  completed_on: isS03 || isS04 || isS05 || isS06 || isS07 || isS08 || isS09 || isS10 || isS11 || isS12 || isS13 || isS14
    ? "2026-07-28"
    : "2026-07-27",
  authoring: {
    workbooks: [
  ...
  records: partition.record_ids.map((id) => ({
    ...
    ...(id.includes(".choice.") ? {
      execution_kind:
        isS14 && [
          "universe.occurrence.8.variant.10601.choice.01",
          "universe.occurrence.8.variant.10601.choice.02",
        ].includes(id)
                ...
                : isS06
                  ...
                  : isS07
                    ...
                    : isS08
                      ...
                      : isS14
                        ? ["node tools/goal07/refine-occurrence-s14.mjs"]
            : []),
