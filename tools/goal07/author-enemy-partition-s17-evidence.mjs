...
const partitionId = "G07-P5-M15-S17";
const write = process.argv.includes("--write");
assert(
  process.argv.slice(2).every((argument) => argument === "--write"),
  "usage: author-enemy-partition-s17-evidence.mjs [--write]",
);
...
const specs = [
  ["enemy.thunderspawn.minion.variant.01", "8001040", [51, 52, 54, 55], "Thunderspawn"],
  ["enemy.trotter-of-abundance.minionlv2.02.variant.01", "8002071", [34, 37, 47, 54, 57], "Trotter_of_Abundance"],
  ["enemy.trotter-of-abundance.minionlv2.variant.01", "8002070", [24], "Trotter_of_Abundance"],
  ["enemy.trotter-of-destruction.minionlv2.02.variant.01", "8002061", [34, 37, 47, 54, 57], "Trotter_of_Destruction"],
  ["enemy.trotter-of-destruction.minionlv2.variant.01", "8002060", [24], "Trotter_of_Destruction"],
  ["enemy.trotter-of-preservation.minionlv2.03.variant.01", "8002082", [34, 37, 47, 54, 57], "Trotter_of_Preservation"],
  ["enemy.trotter-of-preservation.minionlv2.variant.01", "8002080", [24], "Trotter_of_Preservation"],
  ["enemy.vagrant.minionlv2.variant.01", "1002020", [31, 34, 37, 54, 57], "Vagrant"],
  ["enemy.voidranger-distorter.minionlv2.variant.01", "8012020", [7, 21, 22, 24, 25, 27, 51], "Voidranger%3A_Distorter"],
  ["enemy.voidranger-eliminator.minionlv2.variant.01", "8012030", [7, 22, 24, 27, 28], "Voidranger%3A_Eliminator"],
  ["enemy.voidranger-reaver.minionlv2.variant.01", "8012010", [7, 21, 22, 24, 25, 27, 28, 44, 51, 54], "Voidranger%3A_Reaver"],
  ["enemy.voidranger-trampler-bug.elite.variant.01", "8013011", [53, 69, 78, 87], "Voidranger%3A_Trampler"],
].map(([id, source, levels, page]) => ({
  id,
  source,
  levels,
  accuracy: "ExactPublic",
  publicUrl: `https://honkai-star-rail.fandom.com/wiki/${page}`,
}));
...
const hp930 = {
  7: 1455, 21: 3020, 22: 3226, 24: 3638, 25: 3845, 27: 4257,
  28: 4463, 31: 5274, 34: 6469, 37: 7663, 44: 13551, 47: 17071,
  51: 23435, 52: 26279, 53: 29123, 54: 31968, 55: 34812,
  57: 40501, 69: 84408, 78: 127788, 87: 192070,
};
const atk = {
  7: 23, 21: 57, 22: 62, 24: 71, 25: 75, 27: 84, 28: 89, 31: 104,
  34: 121, 37: 138, 44: 187, 47: 210, 51: 244, 52: 255, 53: 265,
  54: 276, 55: 286, 57: 307, 69: 426, 78: 529, 87: 630,
};

const anchor = {
  schema_revision: "starclock.goal07-enemy-numeric-anchor.v2",
  partition_id: partitionId,
  numeric_policy_id: "goal07-s17-public-level-curve-v1",
  source: {
    publisher: "Honkai: Star Rail Wiki and committed version 4.4 extraction",
    url: "https://honkai-star-rail.fandom.com/wiki/Voidranger%3A_Reaver",
  ...
  derivation: {
    ...
    exact_overrides:
      "Each variant uses the reviewed public curve scaled by its committed version 4.4 HP, DEF, SPD and effect-resistance bases.",
  },
  variants: specs.map((spec) => {
    ...
    return {
      ...
      levels: spec.levels.map((level) => ({
        ...
        base_def: String(Math.floor(((200 + level * 10) * baseDef) / 210 + 0.5)),
...
const review = {
  ...
  sources: [
    ...
    source(variantsPath, ["weaknesses, resistances and debuff resistance"]),
    source(difficultiesPath, ["all frozen Standard Universe difficulty levels"]),
    source(encountersPath, ["17 frozen encounter members and every referenced encounter level"]),
    {
      path: anchorPath,
      sha256: anchorDigest,
      facts: [
  ...
  reviewed_runtime_boundaries: [
    ...
    "The pre-existing exact Voidranger Reaver identity is upgraded in place and covered at every S17 encounter level.",
    "Trotters retain Scared, Run and Escaped action order plus their Abundance, Destruction or Preservation passive state.",
    "Thunderspawn retains Lightning damage, Shock, Lightning resistance and Shock immunity.",
    "Vagrant retains its 250% Physical attack and ally Inspire action advance.",
    "Distorter retains Nihility's Command and 500% Quantum strike boundaries.",
    "Eliminator retains Detonated, Overloaded and Thermal Barrier boundaries.",
    "The bug Trampler retains its extracted 800% End of Bow ratio, lock and Entanglement.",
...
console.log(`${write ? "Authored" : "Verified"} Goal 07 S17 numeric anchors and source review.`);
