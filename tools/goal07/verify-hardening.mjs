...
const sources = {
  ...
  activityHardening: "crates/starclock-activity/tests/activity_hardening.rs",
  activityTransaction: "crates/starclock-activity/tests/activity_transaction.rs",
  combatRng: "crates/starclock-combat/tests/rng_golden.rs",
  combatResources: "crates/starclock-combat/tests/action_resources.rs",
  curioRuntime: "crates/starclock-mode-universe/tests/curio_runtime.rs",
  runRuntime: "crates/starclock-mode-universe/tests/run_runtime.rs",
  runLongRun:
    "crates/starclock-mode-universe/tests/run_runtime/hardening.rs",
  activitySession: "crates/starclock-agent-api/tests/activity_session_loop.rs",
  agentHardening: "crates/starclock-agent-api/tests/hardening_corpus.rs",
  standardSessions: "crates/starclock-agent-api/tests/standard_session_loop.rs",
};
