...
assert(universe.dependencies.every((dependency) => ["starclock-activity", "starclock-ai", "starclock-combat", "starclock-data", "starclock-replay", "serde", "serde_json", "sha2", "zstd"].includes(dependency.name)), "starclock-mode-universe may use only generic Activity/combat/AI/replay boundaries, stable data catalogs and generated-reader transport/hash dependencies");
