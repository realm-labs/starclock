...
const policy = JSON.parse(await readFile("policy/agent-api.json", "utf8"));
const fail = (message) => { throw new Error(`agent-api: ${message}`); };
...
console.log(`agent-api verified: ${actualDigest}`);
