...
assert(universeManifest.includes("sha2.workspace = true") && universeManifest.includes("serde.workspace = true") && universeManifest.includes("serde_json.workspace = true") && universeManifest.includes("zstd.workspace = true"), "Universe private reader/hash dependencies differ");
...
assert(JSON.stringify(universeJsonUsers) === JSON.stringify([
  ...
  "crates/starclock-mode-universe/src/swarm_disaster_content/encounter_access.rs",
  ...
  "crates/starclock-mode-universe/src/swarm_disaster_entry/audience_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/boss_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/communing.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/communing_rule_runtime.rs",
  ...
  "crates/starclock-mode-universe/src/swarm_disaster_entry/curio_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/dice_control.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/disarray_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/encounter_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/face_effect.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/occurrence_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/occurrence_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/path_rule_runtime.rs",
  ...
  "crates/starclock-mode-universe/src/swarm_disaster_entry/progression_rule_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/semantic_fixture_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/service_adventure_runtime.rs",
  "crates/starclock-mode-universe/src/swarm_disaster_entry/service_rule_runtime.rs",
