...
enums.push(["DuDomainDeckPolicy", ["ExplicitSourceDeck"]]);
enums.push(["DuDomainCardKind", ["Battle", "Encounter", "Event", "Coin", "Shop", "Reward", "Adventure", "Reforge", "Elite"]]);
tables.push(["DuDomainDecks", "DomainDecks", fields([
  ["style_source", "string"], ["policy", "enum<DuDomainDeckPolicy>"],
  ["card_count", "i32", [1, 256]],
  ["policy_note", "string"], ["replacement_condition", "string"],
  ["source_locator", "string"], ["source_ids", "list<ref<DuDecisionSources.id>>"],
])] );
tables.push(["DuDomainCards", "DomainCards", fields([
  ["deck_id", "ref<DuDomainDecks.id>"], ["ordinal", "i32", [1, 256]],
  ["preset_source", "string"], ["kind", "enum<DuDomainCardKind>"],
  ["level", "i32", [1, 5]], ["source_locator", "string"],
  ["source_ids", "list<ref<DuDecisionSources.id>>"],
])] );
