...
function file(
  ...
  return {
    ...
    optional_domain_fields: optionalDomainFields,
  };
}
...
const files = [
  ...
  file("difficulties.json", "P1-B1", ["difficulties"],
    ["rank_bounds", "enemy_scaling_refs", "enemy_scaling",
      "enemy_affix_choice_counts", "binary_difficulty_rule", "gambit_rules"]),
  ...
  file("roster-avatars.json", "P1-B3", ["roster_avatars"],
    ["avatar_id", "cost", "rarity", "role_id", "build_mapping_id", "position_kind",
      "trait_ids", "backend_rank_ids"]),
  file("economy-rules.json", "P1-B3", ["economy_shop_envelopes"],
    ["currency_ids", "experience_rules", "interest_rules", "refresh_rules",
      "team_size_rules"]),
  ...
  file("team-size-states.json", "P1-B3", [],
    ["level", "field_cap", "bench_cap", "next_level_experience", "transition_rules",
      "general_properties"]),
  ...
  file("character-empowerments.json", "P1-B4", [],
    ["source_id", "avatar_id", "position_id", "activation", "effect_ids", "teardown"],
    ["category_tags", "skill_level", "cooldown", "initial_cooldown",
      "sp_multiple_ratio", "delay_ratio", "parameter_values"]),
  file("battle-overrides.json", "P1-B4", [],
    ["source_id", "rule_kind", "trigger", "parameters", "ordered_operations",
      "teardown"]),

  file("bonds.json", "P1-B5", ["bond_envelopes"],
    ["source_id", "member_ids", "level_ids", "recompute_timing",
      "contribution_ids", "activation_type"],
    ["battle_event_ids", "trait_effect_ids", "parent_bond_id",
      "selection_rules"]),
  file("bond-levels.json", "P1-B5", [],
    ["source_id", "bond_id", "level", "threshold", "threshold_semantics",
      "effect_ids", "property_bind_type"],
    ["trait_member_properties", "all_member_properties",
      "override_battle_event_properties", "property_parameters"]),
  file("bond-contributions.json", "P1-B5", [],
    ["source_id", "bond_id", "level", "scope", "activation",
      "ordered_effects"], ["parameters"]),

  file("star-states.json", "P1-B6", ["star_upgrade_envelopes"],
    ["avatar_id", "star_level", "copy_count", "scaling_refs", "rank_attachments",
      "battle_event_id", "skill_override_source_ids",
      "skill_override_destination_ids", "front_skill_ids",
      "back_execution_skill_ids", "back_skill_ids", "back_ability_name",
      "config_path", "ai_path", "property_modifiers"],
    ["servant_id", "front_power_base", "back_power_base", "luck_chance",
      "luck_damage", "extra_heal_base", "extra_shield_base", "hp_base",
      "hp_inherit", "hp_skill_id", "speed_base", "speed_inherit",
      "speed_skill_id"]),
  file("influence-properties.json", "P1-B6", [],
    ["subject_kind", "subject_level", "properties"]),
  file("contribution-parameters.json", "P1-B6", [],
    ["source_kind", "source_id", "consumer_policy"],
    ["combination_ids", "bonus_numbers", "value"]),
  ...
  file("trial-builds.json", "P1-B7", [],
    ["role_id", "avatar_id", "special_avatar_id", "world_level", "level",
      "promotion", "eidolon", "skill_tree_template", "skill_tree_key",
      "equipment_id", "equipment_level", "equipment_promotion",
      "equipment_rank", "source_ability_bindings", "relic_property_type", "relic_property_type_extra",
      "relic_main_value", "relic_sub_value", "relic_main_properties",
      "relic_sub_properties", "relic_sets"]),
  ...
  file("build-mappings.json", "P1-B7", [],
    ["source_id", "avatar_id", "level", "trace_state", "light_cone",
      "relics", "account_mutation"], ["special_avatar_id"]),
  ...
  file("off-field-conversions.json", "P1-B7", [],
    ["source_id", "source_kind", "eligibility", "conversion",
      "destination_state"]),
  file("equipment.json", "P1-B7", [],
    ["source_id", "slot", "eligibility", "effect_ids", "replacement_rule"],
    ["parameters"]),

  file("augment-definitions.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["category_id", "quality", "chapter_limits", "effect_ids", "config_path", "lifecycle"]),
  file("augment-maze-buffs.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["buff_series", "level", "binding", "parameters", "modifier"]),
  file("augment-monster-rules.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["quality", "parameters", "effect_ids"]),
  file("augment-remarks.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["augment_id", "remark"]),
  file("enhancements.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["group_id", "cost", "parameters", "effect_ids"]),
  file("module-ban-rules.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["module_id", "subject_kind", "subject_id"]),
  file("orbs.json", "P1-B8", ["investment_environment_strategy_persona"],
    ["bonus_id", "orb_type", "effect_ids"]),
  file("orb-displays.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["orb_type", "display_locator"]),
  file("portal-buffs.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["config_path", "effect_ids", "bonus_ids", "lifecycle"]),
  file("portal-maze-buffs.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["buff_series", "level", "binding", "parameters", "modifier"]),
  file("portal-remarks.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["portal_id", "remark"]),
  file("projection-maze-buffs.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["buff_series", "level", "binding", "parameters", "modifier"]),
  file("projections.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["role_id", "unlock_type", "trait_ids", "effect_ids"]),
  file("season-augment-memberships.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["season_id", "augment_id"]),
  file("season-portal-memberships.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["season_id", "portal_id"]),
  file("season-talents.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["season_id", "cost", "prerequisite_ids", "successor_ids", "effect_ids", "config_path"]),
  file("selected-enhancements.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["trait_effect_id", "cost", "parameters", "effect_ids"]),
  file("talents.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["cost", "prerequisite_ids", "successor_ids", "effect_ids", "config_path"]),
  file("talent-maze-buffs.json", "P1-B8",
    ["investment_environment_strategy_persona"],
    ["buff_series", "level", "binding", "parameters", "modifier"]),
  ...
  file("reward-definitions.json", "P2-B4", ["economy_shop_envelopes"],
    ["source_id", "operation_kind", "parameters"],
    ["budget_cost", "scalar_parameter"]),
  file("reward-pools.json", "P2-B4", ["economy_shop_envelopes"],
    ["source_id", "total_value", "candidate_bonus_ids",
      "candidate_maximums", "candidate_weights", "fallback"]),
  file("equipment-recipes.json", "P2-B4",
    ["build_mappings_equipment_conversions"],
    ["source_id", "season_id", "output_equipment_id",
      "input_equipment_ids"]),
  file("equipment-upgrades.json", "P2-B4",
    ["build_mappings_equipment_conversions"],
    ["source_equipment_id", "output_equipment_id"]),
  file("forge-services.json", "P2-B4",
    ["build_mappings_equipment_conversions"],
    ["source_id", "equipment_category", "offer_count", "target_kind",
      "parameters"]),
  file("service-constants.json", "P2-B4", ["economy_shop_envelopes"],
    ["source_id", "value", "consumer_policy"]),

  file("encounter-source-obligations.json", "P2-B5",
    ["encounter_source_obligations"],
    ["parent_kind", "parent_id", "resolution_state"],
    ["stage_id", "camp_ids", "stage_snapshot", "replacement_condition"]),
  file("encounter-groups.json", "P2-B5", [],
    ["plane_id", "difficulty_id", "rank", "candidate_stage_ids", "monster_ids",
      "battle_area_ids", "boss_battle_area_id", "randomization"]),
  ...
  file("boss-pools.json", "P2-B5", [],
    ["plane_id", "difficulty_id", "candidate_monster_ids", "selection_policy",
      "boss_battle_area_id", "candidate_stage_ids"]),
