...
const allCurrentIds = new Set([...contentById.keys(), ...ruleIds]);
...
for (const fixture of fixtures) requireMany(fixture.id, fixture.input_ids, allCurrentIds, "fixture input");
...
console.log(
  `Standard universe current audit passed: ${contentById.size} content rows, ${rules.length} rules, ` +
