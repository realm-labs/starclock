...
for (const marker of ["config/universe-project.toml", "config/universe-generated/", "not the runtime `config/generated/config.sora`", "A future Universe runtime goal"])
