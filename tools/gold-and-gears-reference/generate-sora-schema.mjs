...
const contentTables = [
  {
    name: "GoldGearsBlessing",
    sheet: "Blessing",
    normalized: "blessings.json",
    fields: [
      string("source_id", 32),
      string("source_mode_owner", 80),
      string("pool_membership", 100),
      string("reachability_path_id", 240),
      string("path_id", 240),
      integer("rarity", 1, 3),
  ...
  },
  {
    ...
    fields: [
      ...
      string("pool_membership", 100),
      string("reachability_path_id", 240),
      ref("blessing_id", "GoldGearsBlessing"),
      integer("level", 1, 2),
      json("parameter_values_json"),
      list("inherited_rule_ids", 64),
      string("source_modifier_name", 200),
      string("source_binding_type", 160),
      string("source_binding_key", 160),
      string("source_maze_buff_type", 32),
      string("source_description_sha256_en", 64),
      string("source_description_sha256_zh_cn", 64),
    ],
  },
  {
    ...
    fields: [
      ...
      list("source_mode_types", 32, false),
      integer("handbook_order", 0),
      string("pool_category", 80),
      string("selection_pool_id", 240),
      string("random_offer_eligibility", 100),
      list("state_ids", 8, false),
      ref("initial_state_id", "GoldGearsCurioState"),
      list("mechanic_tags", 64),
      string("source_description_sha256_en", 64),
      string("source_description_sha256_zh_cn", 64),
      string("rule_contribution_id", 240),
  ...
  {
    name: "GoldGearsCurioState",
    sheet: "CurioState",
    normalized: "curio-states.json",
    fields: [
      string("source_id", 32),
      ref("curio_id", "GoldGearsCurio"),
      string("handbook_source_id", 32),
      integer("state_index", 0, 100),
      string("state_kind", 80),
      string("pool_category", 80),
      json("lifecycle_json"),
      json("repair_target_json"),
      json("parameter_values_json"),
      json("display_parameter_values_json"),
      list("extra_effect_source_ids", 64),
      string("source_effect_id", 32),
      string("source_description_sha256_en", 64),
      string("source_description_sha256_zh_cn", 64),
  ...
  },
  {
    ...
    fields: [
      ...
      list("source_mode_types", 32, false),
      integer("handbook_order", 0),
      string("source_event_type", 80),
      list("variant_ids", 32, false),
      string("choice_graph_id", 240),
      list("pool_tags", 64),
      string("rule_contribution_id", 240),
    ],
  },
  {
    name: "GoldGearsOccurrenceVariant",
    sheet: "OccurrenceVariant",
    normalized: "occurrence-variants.json",
    fields: [
      string("source_id", 32),
      ref("occurrence_id", "GoldGearsOccurrence"),
      list("occurrence_ids", 16, false),
      list("handbook_source_ids", 16, false),
      string("entry_node_id", 240),
      list("condition_ids", 64),
      list("choice_ids", 32, false),
      string("source_dialogue_type", 80),
      string("rule_contribution_id", 240),
    ],
  },
  {
    name: "GoldGearsOccurrenceChoice",
    ...
    fields: [
      ...
      json("costs_json"),
      json("outcomes_json"),
      string("next_node_id", 240, true),
      string("choice_label_sha256_en", 64),
      string("choice_label_sha256_zh_cn", 64),
      string("result_sha256_en", 64),
      string("result_sha256_zh_cn", 64),
      json("parameter_vectors_json"),
      string("rule_contribution_id", 240),
    ],
  },
  {
    name: "GoldGearsService",
    sheet: "Service",
  ...
  {
    name: "GoldGearsAdventureOutcome",
    ...
    fields: [
      ...
      json("reward_selection_policy_json"),
      ref("downloader_service_id", "GoldGearsService"),
      string("rule_contribution_id", 240),
    ],
  },
  {
    name: "GoldGearsEncounterGroup",
    sheet: "EncounterGroup",
    normalized: "encounter-groups.json",
    fields: [
      string("parent_room_id", 240, true),
      json("parent_room_scope_json"),
      string("source_group_id", 32),
      string("source_namespace", 100),
      string("encounter_role", 100),
      list("eligible_area_ids", 32, false),
...
const evidenceTables = [
  {
    name: "GoldGearsMechanicRule",
    sheet: "MechanicRule",
    normalized: "mechanic-rules.json",
    fields: [
      string("family_id", 160),
      string("owner_id", 240),
      string("source_file", 240),
      string("execution_disposition", 100),
      string("runtime_handler_id", 240, true),
      string("trigger_boundary", 160),
      json("state_contract_json"),
      json("source_binding_json"),
      json("parameter_values_json"),
      json("effect_contributions_json"),
      json("outcome_program_json"),
      json("selection_policy_json"),
      boolean("policy_bound"),
      string("unresolved_behavior", 100),
...
generate("content.toml", "GoldAndGearsContent.xlsx", contentTables);
generate("evidence.toml", "GoldAndGearsEvidence.xlsx", evidenceTables);
const tableCount = coreTables.length + progressionTables.length + contentTables.length + evidenceTables.length;
console.log(`Generated Gold and Gears Sora schema (${tableCount} tables).`);
