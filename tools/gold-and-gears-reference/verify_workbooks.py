"""Verify complete Goal 08 workbooks against normalized rows and Sora schema."""
...
def main() -> None:
    ...
    parser.add_argument("--data-root", type=Path, default=Path("config/gold-and-gears/data"))
