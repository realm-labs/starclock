...
function verifySchemaLock(file) {
  ...
  assertVariantSet(unions.get("ValueExpressionNode"), ["IntegerLiteral", "ScalarLiteral", "RatioLiteral", "ProbabilityLiteral", "StableIdLiteral", "BooleanLiteral", "ReadStateSlot", "AbilityParameter", "ReadResource", "QueryStat", "QueryEffectStacks", "ReadEventProperty", "SelectorCount", "SelectorSum", "CheckedBinary", "Clamp", "Negate", "Choose", "Convert"]);
