...
// Goal 01 freezes the released floor. Later one-way mode crates may add public
// domain declarations without weakening or removing the released facades.
assert(architecture.public_api_audit.public_declarations >= 3208, "public declaration count regressed");
