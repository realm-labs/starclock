...
Run with the repository-pinned adapter:
  uv run --with openpyxl python tools/config-production/author-standard.py --write
  uv run --with openpyxl python tools/config-production/author-standard.py --check
...
def generated_rows() -> tuple[dict[str, list[dict[str, Any]]], list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    for variant in sorted(variants, key=lambda item: item["id"]):
        ...
        rows["EnemyStat"].append({
            ...
            "spd_decimal": scaled("spd"), "effect_hit_rate_decimal": "0",
            "effect_resistance_decimal": canonical_decimal(stats["effect_res"] or "0"),
    ...
    later_fields = {
        ...
        "EnemyAbility": "id",
        "EnemyDebuffResistance": "variant_id",
        "EnemyPhase": "id",
        "EnemyResistance": "variant_id",
        "EnemyStat": "variant_id",
        "EnemyTemplate": "id",
        "EnemyToughnessLayer": "variant_id",
        "EnemyVariant": "id",
        "EnemyVariantAbility": "variant_id",
        "EnemyWeakness": "variant_id",
        "HitPlan": "id",
