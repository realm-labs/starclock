...
#[path = "../../../../config/anomaly-arbitration-generated/readers/rust/mod.rs"]
mod generated;

use generated::{SoraConfig, runtime::SoraBundle};

const EXPECTED_TABLES: usize = 37;
const EXPECTED_ROWS: usize = 2_103;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Anomaly Arbitration bundle loaded through all {EXPECTED_TABLES} generated tables \
         ({EXPECTED_ROWS} rows)."
    );
    Ok(())
}
